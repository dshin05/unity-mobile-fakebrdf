...
void main ()
{
  ...
  vec4 frag_6;
  frag_6.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz), 0.0, 1.0))) * tmpvar_4);
  frag_6.w = diff_2.w;
  c_1.w = frag_6.w;
  c_1.xyz = (frag_6.xyz + (tmpvar_4 * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + (((tmpvar_5.xyz * tmpvar_5.w) * diff_2.xyz) * _ExposureIBL.x));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec4 frag_11;
  frag_11.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (tmpvar_2, lightDir_10), 0.0, 1.0))) * tmpvar_7);
  frag_11.w = diff_4.w;
  c_1 = frag_11;
  mediump vec3 tmpvar_12;
  tmpvar_12 = (c_1.xyz + (tmpvar_7 * xlv_TEXCOORD3));
  c_1.xyz = tmpvar_12;
  mediump vec3 tmpvar_13;
  tmpvar_13 = (c_1.xyz + (((diff_8.xyz * diff_8.w) * diff_4.xyz) * _ExposureIBL.x));
  c_1.xyz = tmpvar_13;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((diff_2.xyz * tmpvar_3.w) * ((8.0 * tmpvar_5.w) * tmpvar_5.xyz));
  c_1.w = diff_2.w;
...
void main ()
{
  ...
  tmpvar_10 = ((diff_3.xyz * diff_3.w) * tmpvar_9);
  c_1.xyz = tmpvar_10;
  c_1.w = tmpvar_6;
  mediump vec3 tmpvar_11;
...
void main ()
{
  ...
  tmpvar_5 = textureCube (_DiffCubeIBL, xlv_TEXCOORD1);
  vec4 frag_6;
  frag_6.xyz = ((_LightColor0.xyz * ((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD5).x * 2.0) * clamp (dot (xlv_TEXCOORD2, _WorldSpaceLightPos0.xyz), 0.0, 1.0))) * tmpvar_4);
  frag_6.w = diff_2.w;
  c_1.w = frag_6.w;
  c_1.xyz = (frag_6.xyz + (tmpvar_4 * xlv_TEXCOORD3));
  c_1.xyz = (c_1.xyz + (((tmpvar_5.xyz * tmpvar_5.w) * diff_2.xyz) * _ExposureIBL.x));
...
void main ()
{
  ...
  frag_18.xyz = ((_LightColor0.xyz * ((atten_17 * 2.0) * clamp (dot (tmpvar_2, lightDir_16), 0.0, 1.0))) * tmpvar_7);
  frag_18.w = diff_4.w;
  c_1 = frag_18;
  mediump vec3 tmpvar_19;
  tmpvar_19 = (c_1.xyz + (tmpvar_7 * xlv_TEXCOORD3));
  c_1.xyz = tmpvar_19;
  mediump vec3 tmpvar_20;
  tmpvar_20 = (c_1.xyz + (((diff_8.xyz * diff_8.w) * diff_4.xyz) * _ExposureIBL.x));
  c_1.xyz = tmpvar_20;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((diff_2.xyz * tmpvar_3.w) * max (min (tmpvar_7, ((tmpvar_5.x * 2.0) * tmpvar_6.xyz)), (tmpvar_7 * tmpvar_5.x)));
  c_1.w = diff_2.w;
  c_1.xyz = (c_1.xyz + (((tmpvar_4.xyz * tmpvar_4.w) * diff_2.xyz) * _ExposureIBL.x));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_16 = ((diff_3.xyz * diff_3.w) * tmpvar_15);
  c_1.xyz = tmpvar_16;
  c_1.w = tmpvar_6;
...
void main ()
{
  ...
  frag_15.xyz = ((_LightColor0.xyz * ((atten_14 * 2.0) * clamp (dot (tmpvar_2, lightDir_13), 0.0, 1.0))) * tmpvar_7);
  frag_15.w = diff_4.w;
  c_1 = frag_15;
  mediump vec3 tmpvar_16;
  tmpvar_16 = (c_1.xyz + (tmpvar_7 * xlv_TEXCOORD3));
  c_1.xyz = tmpvar_16;
  mediump vec3 tmpvar_17;
  tmpvar_17 = (c_1.xyz + (((diff_8.xyz * diff_8.w) * diff_4.xyz) * _ExposureIBL.x));
  c_1.xyz = tmpvar_17;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 tmpvar_13;
  tmpvar_13 = ((diff_3.xyz * diff_3.w) * tmpvar_12);
  c_1.xyz = tmpvar_13;
  c_1.w = tmpvar_6;
...
void main ()
{
  ...
  diff_2.xyz = (tmpvar_3.xyz * _ExposureIBL.w);
  vec4 frag_4;
  frag_4.xyz = ((_LightColor0.xyz * ((texture2D (_LightTexture0, vec2(dot (xlv_TEXCOORD4, xlv_TEXCOORD4))).w * 2.0) * clamp (dot (xlv_TEXCOORD1, normalize(xlv_TEXCOORD2)), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_4.w = diff_2.w;
  c_1.xyz = frag_4.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_12.xyz = ((_LightColor0.xyz * ((atten_11 * 2.0) * clamp (dot (tmpvar_3, lightDir_10), 0.0, 1.0))) * (diff_4.xyz * diff_4.w));
  frag_12.w = diff_4.w;
  c_1.xyz = frag_12.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_2.xyz = (tmpvar_3.xyz * _ExposureIBL.w);
  vec4 frag_4;
  frag_4.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (xlv_TEXCOORD1, xlv_TEXCOORD2), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_4.w = diff_2.w;
  c_1.xyz = frag_4.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  mediump vec4 frag_8;
  frag_8.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (tmpvar_3, lightDir_7), 0.0, 1.0))) * (diff_4.xyz * diff_4.w));
  frag_8.w = diff_4.w;
  c_1.xyz = frag_8.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_2.xyz = (tmpvar_3.xyz * _ExposureIBL.w);
  vec4 frag_4;
  frag_4.xyz = ((_LightColor0.xyz * ((((float((xlv_TEXCOORD4.z > 0.0)) * texture2D (_LightTexture0, ((xlv_TEXCOORD4.xy / xlv_TEXCOORD4.w) + 0.5)).w) * texture2D (_LightTextureB0, vec2(dot (xlv_TEXCOORD4.xyz, xlv_TEXCOORD4.xyz))).w) * 2.0) * clamp (dot (xlv_TEXCOORD1, normalize(xlv_TEXCOORD2)), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_4.w = diff_2.w;
  c_1.xyz = frag_4.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_14.xyz = ((_LightColor0.xyz * ((atten_13 * 2.0) * clamp (dot (tmpvar_3, lightDir_12), 0.0, 1.0))) * (diff_4.xyz * diff_4.w));
  frag_14.w = diff_4.w;
  c_1.xyz = frag_14.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_2.xyz = (tmpvar_3.xyz * _ExposureIBL.w);
  vec4 frag_4;
  frag_4.xyz = ((_LightColor0.xyz * (((texture2D (_LightTextureB0, vec2(dot (xlv_TEXCOORD4, xlv_TEXCOORD4))).w * textureCube (_LightTexture0, xlv_TEXCOORD4).w) * 2.0) * clamp (dot (xlv_TEXCOORD1, normalize(xlv_TEXCOORD2)), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_4.w = diff_2.w;
  c_1.xyz = frag_4.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_13.xyz = ((_LightColor0.xyz * ((atten_12 * 2.0) * clamp (dot (tmpvar_3, lightDir_11), 0.0, 1.0))) * (diff_4.xyz * diff_4.w));
  frag_13.w = diff_4.w;
  c_1.xyz = frag_13.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  diff_2.xyz = (tmpvar_3.xyz * _ExposureIBL.w);
  vec4 frag_4;
  frag_4.xyz = ((_LightColor0.xyz * ((texture2D (_LightTexture0, xlv_TEXCOORD4).w * 2.0) * clamp (dot (xlv_TEXCOORD1, xlv_TEXCOORD2), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_4.w = diff_2.w;
  c_1.xyz = frag_4.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_10.xyz = ((_LightColor0.xyz * ((atten_9 * 2.0) * clamp (dot (tmpvar_3, lightDir_8), 0.0, 1.0))) * (diff_4.xyz * diff_4.w));
  frag_10.w = diff_4.w;
  c_1.xyz = frag_10.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
