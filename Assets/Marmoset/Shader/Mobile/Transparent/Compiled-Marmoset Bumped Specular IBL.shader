...
void main ()
{
  ...
  spec_2.xyz = (tmpvar_7.xyz * ((_SpecColor.xyz * (_SpecInt * mix (1.0, (tmpvar_8 * (tmpvar_8 * tmpvar_8)), (_Fresnel * 0.9)))) * _ExposureIBL.w));
  float tmpvar_9;
  ...
  vec4 frag_16;
  float tmpvar_17;
  tmpvar_17 = clamp (dot (normal_6, xlv_TEXCOORD6), 0.0, 1.0);
  frag_16.xyz = ((_LightColor0.xyz * (2.0 * tmpvar_17)) * tmpvar_5);
  frag_16.w = diff_3.w;
  frag_16.xyz = (frag_16.xyz + ((((vec3(pow (clamp (dot (normal_6, normalize((normalize(xlv_TEXCOORD1) + xlv_TEXCOORD6))), 0.0, 1.0), tmpvar_10)) * clamp ((10.0 * tmpvar_17), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec_2.xyz * ((tmpvar_10 * 0.159155) + 0.31831))));
  c_1.w = frag_16.w;
  c_1.xyz = (frag_16.xyz + (tmpvar_5 * xlv_TEXCOORD7));
  c_1.xyz = (c_1.xyz + ((((tmpvar_14.xyz * tmpvar_14.w) * spec_2.xyz) * _ExposureIBL.y) + (((tmpvar_15.xyz * tmpvar_15.w) * diff_3.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_18 = (1.0 - clamp (dot (N_8, xlv_TEXCOORD1), 0.0, 1.0));
  factor_17 = tmpvar_18;
  mediump float tmpvar_19;
  tmpvar_19 = (factor_17 * (factor_17 * factor_17));
  factor_17 = tmpvar_19;
  spec_7.xyz = (spec_7.xyz * ((_SpecColor.xyz * (specIntensity_15 * mix (1.0, tmpvar_19, (fresnel_16 * 0.9)))) * _ExposureIBL.w));
  mediump float tmpvar_20;
  mediump float shininess_21;
  shininess_21 = _Shininess;
  tmpvar_20 = ((7.0 + spec_7.w) - (shininess_21 * spec_7.w));
  mediump float tmpvar_22;
  tmpvar_22 = pow (2.0, (8.0 - tmpvar_20));
  highp vec3 tmpvar_23;
  tmpvar_23.x = dot (tmpvar_2, N_8);
  tmpvar_23.y = dot (tmpvar_3, N_8);
  tmpvar_23.z = dot (tmpvar_4, N_8);
  N_8 = tmpvar_23;
  highp vec3 i_24;
  i_24 = -(xlv_TEXCOORD2);
  ...
  tmpvar_31 = (spec_7.xyz * ((gloss_30 * 0.159155) + 0.31831));
  tmpvar_6 = tmpvar_31;
  ...
  lightDir_35 = xlv_TEXCOORD6;
  mediump vec3 viewDir_36;
  viewDir_36 = tmpvar_34;
  mediump vec3 spec_37;
  highp float specRefl_38;
  mediump vec4 frag_39;
  mediump float tmpvar_40;
  tmpvar_40 = clamp (dot (tmpvar_5, lightDir_35), 0.0, 1.0);
  frag_39.xyz = ((_LightColor0.xyz * (2.0 * tmpvar_40)) * tmpvar_12);
  frag_39.w = diff_9.w;
  mediump float tmpvar_41;
  tmpvar_41 = clamp (dot (tmpvar_5, normalize((viewDir_36 + lightDir_35))), 0.0, 1.0);
  specRefl_38 = tmpvar_41;
  highp vec3 tmpvar_42;
  tmpvar_42 = vec3(pow (specRefl_38, tmpvar_22));
  spec_37 = tmpvar_42;
  mediump vec3 tmpvar_43;
  tmpvar_43 = (((spec_37 * clamp ((10.0 * tmpvar_40), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_37 = tmpvar_43;
  frag_39.xyz = (frag_39.xyz + (tmpvar_43 * tmpvar_6));
  c_1 = frag_39;
  mediump vec3 tmpvar_44;
  tmpvar_44 = (c_1.xyz + (tmpvar_12 * xlv_TEXCOORD7));
  c_1.xyz = tmpvar_44;
  mediump vec3 tmpvar_45;
  tmpvar_45 = (c_1.xyz + ((((spec_26.xyz * spec_26.w) * spec_7.xyz) * _ExposureIBL.y) + (((diff_32.xyz * diff_32.w) * diff_9.xyz) * _ExposureIBL.x)));
  c_1.xyz = tmpvar_45;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((diff_3.xyz * tmpvar_4.w) * ((8.0 * tmpvar_14.w) * tmpvar_14.xyz));
  c_1.w = diff_3.w;
...
void main ()
{
  ...
  tmpvar_30 = ((diff_7.xyz * diff_7.w) * tmpvar_29);
  c_1.xyz = tmpvar_30;
  c_1.w = tmpvar_10;
...
void main ()
{
  ...
  tmpvar_15 = textureCube (_DiffCubeIBL, tmpvar_11);
  vec4 tmpvar_16;
  tmpvar_16 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD8);
  vec4 frag_17;
  float tmpvar_18;
  tmpvar_18 = clamp (dot (normal_6, xlv_TEXCOORD6), 0.0, 1.0);
  frag_17.xyz = ((_LightColor0.xyz * ((tmpvar_16.x * 2.0) * tmpvar_18)) * tmpvar_5);
  frag_17.w = diff_3.w;
  frag_17.xyz = (frag_17.xyz + (((((vec3(pow (clamp (dot (normal_6, normalize((normalize(xlv_TEXCOORD1) + xlv_TEXCOORD6))), 0.0, 1.0), tmpvar_10)) * clamp ((10.0 * tmpvar_18), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_16.x) * 0.5) * (spec_2.xyz * ((tmpvar_10 * 0.159155) + 0.31831))));
  c_1.w = frag_17.w;
  c_1.xyz = (frag_17.xyz + (tmpvar_5 * xlv_TEXCOORD7));
  c_1.xyz = (c_1.xyz + ((((tmpvar_14.xyz * tmpvar_14.w) * spec_2.xyz) * _ExposureIBL.y) + (((tmpvar_15.xyz * tmpvar_15.w) * diff_3.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_37 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD8).x;
  dist_36 = tmpvar_37;
  highp float tmpvar_38;
  tmpvar_38 = _LightShadowData.x;
  lightShadowDataX_35 = tmpvar_38;
  highp float tmpvar_39;
  tmpvar_39 = max (float((dist_36 > (xlv_TEXCOORD8.z / xlv_TEXCOORD8.w))), lightShadowDataX_35);
  tmpvar_34 = tmpvar_39;
  ...
  frag_46.xyz = ((_LightColor0.xyz * ((atten_43 * 2.0) * tmpvar_47)) * tmpvar_12);
  frag_46.w = diff_9.w;
  ...
  tmpvar_51 = (c_1.xyz + (tmpvar_12 * xlv_TEXCOORD7));
  c_1.xyz = tmpvar_51;
  mediump vec3 tmpvar_52;
  tmpvar_52 = (c_1.xyz + ((((spec_26.xyz * spec_26.w) * spec_7.xyz) * _ExposureIBL.y) + (((diff_32.xyz * diff_32.w) * diff_9.xyz) * _ExposureIBL.x)));
  c_1.xyz = tmpvar_52;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((diff_3.xyz * tmpvar_4.w) * max (min (tmpvar_16, ((tmpvar_14.x * 2.0) * tmpvar_15.xyz)), (tmpvar_16 * tmpvar_14.x)));
  c_1.w = diff_3.w;
  c_1.xyz = (c_1.xyz + ((((tmpvar_12.xyz * tmpvar_12.w) * spec_2.xyz) * _ExposureIBL.y) + (((tmpvar_13.xyz * tmpvar_13.w) * diff_3.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_36 = ((diff_7.xyz * diff_7.w) * tmpvar_35);
  c_1.xyz = tmpvar_36;
  c_1.w = tmpvar_10;
...
void main ()
{
  ...
  tmpvar_35 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD8.xyz);
  ...
  atten_40 = shadow_34;
  mediump vec3 spec_41;
  highp float specRefl_42;
  mediump vec4 frag_43;
  mediump float tmpvar_44;
  tmpvar_44 = clamp (dot (tmpvar_5, lightDir_38), 0.0, 1.0);
  frag_43.xyz = ((_LightColor0.xyz * ((atten_40 * 2.0) * tmpvar_44)) * tmpvar_12);
  frag_43.w = diff_9.w;
  mediump float tmpvar_45;
  tmpvar_45 = clamp (dot (tmpvar_5, normalize((viewDir_39 + lightDir_38))), 0.0, 1.0);
  specRefl_42 = tmpvar_45;
  highp vec3 tmpvar_46;
  tmpvar_46 = vec3(pow (specRefl_42, tmpvar_22));
  spec_41 = tmpvar_46;
  mediump vec3 tmpvar_47;
  tmpvar_47 = ((((spec_41 * clamp ((10.0 * tmpvar_44), 0.0, 1.0)) * _LightColor0.xyz) * atten_40) * 0.5);
  spec_41 = tmpvar_47;
  frag_43.xyz = (frag_43.xyz + (tmpvar_47 * tmpvar_6));
  c_1 = frag_43;
  mediump vec3 tmpvar_48;
  tmpvar_48 = (c_1.xyz + (tmpvar_12 * xlv_TEXCOORD7));
  c_1.xyz = tmpvar_48;
  mediump vec3 tmpvar_49;
  tmpvar_49 = (c_1.xyz + ((((spec_26.xyz * spec_26.w) * spec_7.xyz) * _ExposureIBL.y) + (((diff_32.xyz * diff_32.w) * diff_9.xyz) * _ExposureIBL.x)));
  c_1.xyz = tmpvar_49;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_33 = ((diff_7.xyz * diff_7.w) * tmpvar_32);
  c_1.xyz = tmpvar_33;
  c_1.w = tmpvar_10;
...
void main ()
{
  ...
  frag_11.xyz = ((_LightColor0.xyz * ((atten_10 * 2.0) * tmpvar_12)) * (diff_3.xyz * tmpvar_4.w));
  frag_11.w = diff_3.w;
...
void main ()
{
  ...
  frag_9.xyz = ((_LightColor0.xyz * (2.0 * tmpvar_10)) * (diff_3.xyz * tmpvar_4.w));
  frag_9.w = diff_3.w;
...
void main ()
{
  ...
  frag_26.xyz = ((_LightColor0.xyz * (2.0 * tmpvar_27)) * (diff_7.xyz * diff_7.w));
  frag_26.w = diff_7.w;
...
void main ()
{
  ...
  frag_32.xyz = ((_LightColor0.xyz * ((atten_29 * 2.0) * tmpvar_33)) * (diff_7.xyz * diff_7.w));
  frag_32.w = diff_7.w;
...
void main ()
{
  ...
  frag_28.xyz = ((_LightColor0.xyz * ((atten_25 * 2.0) * tmpvar_29)) * (diff_7.xyz * diff_7.w));
  frag_28.w = diff_7.w;
