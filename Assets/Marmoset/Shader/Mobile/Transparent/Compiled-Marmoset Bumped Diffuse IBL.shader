...
void main ()
{
  ...
  vec3 tmpvar_4;
  tmpvar_4 = (diff_2.xyz * tmpvar_3.w);
  vec3 normal_5;
  ...
  vec4 frag_8;
  frag_8.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (normal_5, xlv_TEXCOORD4), 0.0, 1.0))) * tmpvar_4);
  frag_8.w = diff_2.w;
  c_1.w = frag_8.w;
  c_1.xyz = (frag_8.xyz + (tmpvar_4 * xlv_TEXCOORD5));
  c_1.xyz = (c_1.xyz + (((tmpvar_7.xyz * tmpvar_7.w) * diff_2.xyz) * _ExposureIBL.x));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  frag_16.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (tmpvar_5, lightDir_15), 0.0, 1.0))) * tmpvar_10);
  frag_16.w = diff_7.w;
  c_1 = frag_16;
  mediump vec3 tmpvar_17;
  tmpvar_17 = (c_1.xyz + (tmpvar_10 * xlv_TEXCOORD5));
  c_1.xyz = tmpvar_17;
  mediump vec3 tmpvar_18;
  tmpvar_18 = (c_1.xyz + (((diff_13.xyz * diff_13.w) * diff_7.xyz) * _ExposureIBL.x));
  c_1.xyz = tmpvar_18;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((diff_2.xyz * tmpvar_3.w) * ((8.0 * tmpvar_7.w) * tmpvar_7.xyz));
  c_1.w = diff_2.w;
...
void main ()
{
  ...
  tmpvar_15 = ((diff_6.xyz * diff_6.w) * tmpvar_14);
  c_1.xyz = tmpvar_15;
  c_1.w = tmpvar_9;
...
void main ()
{
  ...
  tmpvar_7 = textureCube (_DiffCubeIBL, tmpvar_6);
  vec4 frag_8;
  frag_8.xyz = ((_LightColor0.xyz * ((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7).x * 2.0) * clamp (dot (normal_5, xlv_TEXCOORD4), 0.0, 1.0))) * tmpvar_4);
  frag_8.w = diff_2.w;
  c_1.w = frag_8.w;
  c_1.xyz = (frag_8.xyz + (tmpvar_4 * xlv_TEXCOORD5));
  c_1.xyz = (c_1.xyz + (((tmpvar_7.xyz * tmpvar_7.w) * diff_2.xyz) * _ExposureIBL.x));
...
void main ()
{
  ...
  tmpvar_20 = max (float((dist_17 > (xlv_TEXCOORD7.z / xlv_TEXCOORD7.w))), lightShadowDataX_16);
  tmpvar_15 = tmpvar_20;
  ...
  frag_23.xyz = ((_LightColor0.xyz * ((atten_22 * 2.0) * clamp (dot (tmpvar_5, lightDir_21), 0.0, 1.0))) * tmpvar_10);
  frag_23.w = diff_7.w;
  c_1 = frag_23;
  mediump vec3 tmpvar_24;
  tmpvar_24 = (c_1.xyz + (tmpvar_10 * xlv_TEXCOORD5));
  c_1.xyz = tmpvar_24;
  mediump vec3 tmpvar_25;
  tmpvar_25 = (c_1.xyz + (((diff_13.xyz * diff_13.w) * diff_7.xyz) * _ExposureIBL.x));
  c_1.xyz = tmpvar_25;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_1.xyz = ((diff_2.xyz * tmpvar_3.w) * max (min (tmpvar_9, ((tmpvar_7.x * 2.0) * tmpvar_8.xyz)), (tmpvar_9 * tmpvar_7.x)));
  c_1.w = diff_2.w;
  c_1.xyz = (c_1.xyz + (((tmpvar_6.xyz * tmpvar_6.w) * diff_2.xyz) * _ExposureIBL.x));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_21 = ((diff_6.xyz * diff_6.w) * tmpvar_20);
  c_1.xyz = tmpvar_21;
  c_1.w = tmpvar_9;
  mediump vec3 tmpvar_22;
...
void main ()
{
  ...
  tmpvar_16 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD7.xyz);
  ...
  frag_20.xyz = ((_LightColor0.xyz * ((atten_19 * 2.0) * clamp (dot (tmpvar_5, lightDir_18), 0.0, 1.0))) * tmpvar_10);
  frag_20.w = diff_7.w;
  c_1 = frag_20;
  mediump vec3 tmpvar_21;
  tmpvar_21 = (c_1.xyz + (tmpvar_10 * xlv_TEXCOORD5));
  c_1.xyz = tmpvar_21;
  mediump vec3 tmpvar_22;
  tmpvar_22 = (c_1.xyz + (((diff_13.xyz * diff_13.w) * diff_7.xyz) * _ExposureIBL.x));
  c_1.xyz = tmpvar_22;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 tmpvar_18;
  tmpvar_18 = ((diff_6.xyz * diff_6.w) * tmpvar_17);
  c_1.xyz = tmpvar_18;
  c_1.w = tmpvar_9;
...
void main ()
{
  ...
  normal_4.z = sqrt(((1.0 - (normal_4.x * normal_4.x)) - (normal_4.y * normal_4.y)));
  vec4 frag_5;
  frag_5.xyz = ((_LightColor0.xyz * ((texture2D (_LightTexture0, vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3))).w * 2.0) * clamp (dot (normal_4, normalize(xlv_TEXCOORD1)), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_5.w = diff_2.w;
  c_1.xyz = frag_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_14.xyz = ((_LightColor0.xyz * ((atten_13 * 2.0) * clamp (dot (tmpvar_3, lightDir_12), 0.0, 1.0))) * (diff_5.xyz * diff_5.w));
  frag_14.w = diff_5.w;
  c_1.xyz = frag_14.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  normal_4.z = sqrt(((1.0 - (normal_4.x * normal_4.x)) - (normal_4.y * normal_4.y)));
  vec4 frag_5;
  frag_5.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (normal_4, xlv_TEXCOORD1), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_5.w = diff_2.w;
  c_1.xyz = frag_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_10.xyz = ((_LightColor0.xyz * (2.0 * clamp (dot (tmpvar_3, lightDir_9), 0.0, 1.0))) * (diff_5.xyz * diff_5.w));
  frag_10.w = diff_5.w;
  c_1.xyz = frag_10.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  normal_4.z = sqrt(((1.0 - (normal_4.x * normal_4.x)) - (normal_4.y * normal_4.y)));
  vec4 frag_5;
  frag_5.xyz = ((_LightColor0.xyz * ((((float((xlv_TEXCOORD3.z > 0.0)) * texture2D (_LightTexture0, ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.5)).w) * texture2D (_LightTextureB0, vec2(dot (xlv_TEXCOORD3.xyz, xlv_TEXCOORD3.xyz))).w) * 2.0) * clamp (dot (normal_4, normalize(xlv_TEXCOORD1)), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_5.w = diff_2.w;
  c_1.xyz = frag_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  mediump vec4 frag_16;
  frag_16.xyz = ((_LightColor0.xyz * ((atten_15 * 2.0) * clamp (dot (tmpvar_3, lightDir_14), 0.0, 1.0))) * (diff_5.xyz * diff_5.w));
  frag_16.w = diff_5.w;
  c_1.xyz = frag_16.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  normal_4.z = sqrt(((1.0 - (normal_4.x * normal_4.x)) - (normal_4.y * normal_4.y)));
  vec4 frag_5;
  frag_5.xyz = ((_LightColor0.xyz * (((texture2D (_LightTextureB0, vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3))).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w) * 2.0) * clamp (dot (normal_4, normalize(xlv_TEXCOORD1)), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_5.w = diff_2.w;
  c_1.xyz = frag_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_15.xyz = ((_LightColor0.xyz * ((atten_14 * 2.0) * clamp (dot (tmpvar_3, lightDir_13), 0.0, 1.0))) * (diff_5.xyz * diff_5.w));
  frag_15.w = diff_5.w;
  c_1.xyz = frag_15.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  normal_4.z = sqrt(((1.0 - (normal_4.x * normal_4.x)) - (normal_4.y * normal_4.y)));
  vec4 frag_5;
  frag_5.xyz = ((_LightColor0.xyz * ((texture2D (_LightTexture0, xlv_TEXCOORD3).w * 2.0) * clamp (dot (normal_4, xlv_TEXCOORD1), 0.0, 1.0))) * (diff_2.xyz * tmpvar_3.w));
  frag_5.w = diff_2.w;
  c_1.xyz = frag_5.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  frag_12.xyz = ((_LightColor0.xyz * ((atten_11 * 2.0) * clamp (dot (tmpvar_3, lightDir_10), 0.0, 1.0))) * (diff_5.xyz * diff_5.w));
  frag_12.w = diff_5.w;
  c_1.xyz = frag_12.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
