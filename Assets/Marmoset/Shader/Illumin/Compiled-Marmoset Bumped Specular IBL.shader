...
void main ()
{
  ...
  spec.xyz = (tmpvar_7.xyz * ((_SpecColor.xyz * ((0.05 + (0.95 * dot (p.xy, tmpvar_10))) * _SpecInt)) * _ExposureIBL.w));
  float tmpvar_11;
  float tmpvar_12;
  tmpvar_12 = (1.0 - tmpvar_7.w);
  float tmpvar_13;
  tmpvar_13 = (1.0 - (tmpvar_12 * tmpvar_12));
  tmpvar_11 = ((7.0 + tmpvar_13) - (_Shininess * tmpvar_13));
  float tmpvar_14;
  tmpvar_14 = pow (2.0, (8.0 - tmpvar_11));
  vec3 tmpvar_15;
  tmpvar_15.x = dot (tmpvar_2, tmpvar_6);
  tmpvar_15.y = dot (tmpvar_3, tmpvar_6);
  tmpvar_15.z = dot (tmpvar_4, tmpvar_6);
  vec3 tmpvar_16;
  ...
  vec4 tmpvar_17;
  tmpvar_17.xyz = ((v_i0.xyz * tmpvar_16.x) + ((v_i0_i1.xyz * tmpvar_16.y) + (v_i0_i1_i2.xyz * tmpvar_16.z)));
  tmpvar_17.w = tmpvar_11;
  vec4 tmpvar_18;
  tmpvar_18 = textureCubeLod (_SpecCubeIBL, tmpvar_17.xyz, tmpvar_17.w);
  float tmpvar_19;
  tmpvar_19 = (tmpvar_18.w * tmpvar_18.w);
  vec2 tmpvar_20;
  tmpvar_20.x = tmpvar_19;
  tmpvar_20.y = (tmpvar_18.w * tmpvar_19);
  vec4 v_i0_i0;
  ...
  vec4 tmpvar_21;
  tmpvar_21 = textureCube (_DiffCubeIBL, ((v_i0_i0.xyz * dot (tmpvar_2, tmpvar_6)) + ((v_i0_i1_i0.xyz * dot (tmpvar_3, tmpvar_6)) + (v_i0_i1_i2_i0.xyz * dot (tmpvar_4, tmpvar_6)))));
  float tmpvar_22;
  tmpvar_22 = (tmpvar_21.w * tmpvar_21.w);
  vec2 tmpvar_23;
  tmpvar_23.x = tmpvar_22;
  tmpvar_23.y = (tmpvar_21.w * tmpvar_22);
  vec4 tmpvar_24;
  tmpvar_24 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_24;
  glow.xyz = (tmpvar_24.xyz * _GlowColor.xyz);
  glow.xyz = (glow.xyz * _GlowStrength);
  glow.w = (tmpvar_24.w * _EmissionLM);
  ...
  float tmpvar_26;
  tmpvar_26 = clamp (dot (tmpvar_6, tmpvar_25), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_26) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_25))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_26), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + (((((tmpvar_18.xyz * dot (vec2(0.7532, 0.2468), tmpvar_20)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_21.xyz * dot (vec2(0.7532, 0.2468), tmpvar_23)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_19 = pow (2.0, (8.0 - tmpvar_16));
  highp float gloss;
  gloss = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = (spec.xyz * ((gloss * 0.159155) + 0.31831));
  tmpvar_10 = tmpvar_20;
  ...
  mediump vec4 lookup;
  highp vec4 tmpvar_22;
  tmpvar_22.xyz = reflect (tmpvar_1, tmpvar_21);
  tmpvar_22.w = glossLod_i0_i1;
  lookup = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = textureCubeLod (_SpecCubeIBL, lookup.xyz, lookup.w);
  spec_i0 = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24.x = dot (tmpvar_2, N);
  tmpvar_24.y = dot (tmpvar_3, N);
  tmpvar_24.z = dot (tmpvar_4, N);
  N = tmpvar_24;
  mediump vec4 diff_i0;
  lowp vec4 tmpvar_25;
  tmpvar_25 = textureCube (_DiffCubeIBL, tmpvar_24);
  diff_i0 = tmpvar_25;
  lowp vec4 tmpvar_26;
  tmpvar_26 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_26;
  highp vec3 tmpvar_27;
  tmpvar_27 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_27;
  highp vec3 tmpvar_28;
  tmpvar_28 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_28;
  highp float tmpvar_29;
  tmpvar_29 = (glow.w * _EmissionLM);
  glow.w = tmpvar_29;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump float tmpvar_31;
  tmpvar_31 = clamp (dot (tmpvar_9, lightDir), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_31) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_32;
  tmpvar_32 = clamp (dot (tmpvar_9, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_32;
  highp vec3 tmpvar_33;
  tmpvar_33 = vec3(pow (specRefl, tmpvar_19));
  spec_i0_i1 = tmpvar_33;
  mediump vec3 tmpvar_34;
  tmpvar_34 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_31), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_i0_i1 = tmpvar_34;
  frag.xyz = (frag.xyz + (tmpvar_34 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_35;
  tmpvar_35 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_35;
...
void main ()
{
  ...
  spec.xyz = (spec.xyz * ((_SpecColor.xyz * ((0.05 + (0.95 * dot (p.xy, tmpvar_17))) * specIntensity)) * _ExposureIBL.w));
  mediump float tmpvar_18;
  mediump float shininess;
  shininess = _Shininess;
  mediump float tmpvar_19;
  ...
  tmpvar_21 = pow (2.0, (8.0 - tmpvar_18));
  highp float gloss;
  gloss = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = (spec.xyz * ((gloss * 0.159155) + 0.31831));
  tmpvar_10 = tmpvar_22;
  mediump vec3 tmpvar_23;
  tmpvar_23.x = dot (tmpvar_2, tmpvar_9);
  tmpvar_23.y = dot (tmpvar_3, tmpvar_9);
  tmpvar_23.z = dot (tmpvar_4, tmpvar_9);
  highp vec3 tmpvar_24;
  tmpvar_24 = reflect (tmpvar_1, tmpvar_23);
  vec4 v_i0;
  v_i0.x = _SkyMatrix[0].x;
  v_i0.y = _SkyMatrix[1].x;
  v_i0.z = _SkyMatrix[2].x;
  ...
  tmpvar_25.xyz = ((v_i0.xyz * tmpvar_24.x) + ((v_i0_i1.xyz * tmpvar_24.y) + (v_i0_i1_i2.xyz * tmpvar_24.z)));
  tmpvar_25.w = glossLod_i0_i1;
  lookup = tmpvar_25;
  lowp vec4 tmpvar_26;
  tmpvar_26 = textureCubeLod (_SpecCubeIBL, lookup.xyz, lookup.w);
  spec_i0 = tmpvar_26;
  mediump float tmpvar_27;
  tmpvar_27 = (spec_i0.w * spec_i0.w);
  mediump vec2 tmpvar_28;
  tmpvar_28.x = tmpvar_27;
  tmpvar_28.y = (spec_i0.w * tmpvar_27);
  ...
  v_i0_i1_i2_i0.z = _SkyMatrix[2].z;
  v_i0_i1_i2_i0.w = _SkyMatrix[3].z;
  tmpvar_29 = ((v_i0_i0.xyz * dot (tmpvar_2, tmpvar_13)) + ((v_i0_i1_i0.xyz * dot (tmpvar_3, tmpvar_13)) + (v_i0_i1_i2_i0.xyz * dot (tmpvar_4, tmpvar_13))));
  N = tmpvar_29;
  mediump vec4 diff_i0;
  lowp vec4 tmpvar_30;
  tmpvar_30 = textureCube (_DiffCubeIBL, tmpvar_29);
  diff_i0 = tmpvar_30;
  mediump float tmpvar_31;
  tmpvar_31 = (diff_i0.w * diff_i0.w);
  mediump vec2 tmpvar_32;
  tmpvar_32.x = tmpvar_31;
  tmpvar_32.y = (diff_i0.w * tmpvar_31);
  lowp vec4 tmpvar_33;
  tmpvar_33 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_33;
  highp vec3 tmpvar_34;
  tmpvar_34 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_34;
  highp vec3 tmpvar_35;
  tmpvar_35 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_35;
  highp float tmpvar_36;
  tmpvar_36 = (glow.w * _EmissionLM);
  glow.w = tmpvar_36;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  ...
  tmpvar_38 = normalize (lightDir);
  mediump float tmpvar_39;
  tmpvar_39 = clamp (dot (tmpvar_9, tmpvar_38), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_39) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_40;
  tmpvar_40 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_38))), 0.0, 1.0);
  specRefl = tmpvar_40;
  highp vec3 tmpvar_41;
  tmpvar_41 = vec3(pow (specRefl, tmpvar_21));
  spec_i0_i1 = tmpvar_41;
  mediump vec3 tmpvar_42;
  tmpvar_42 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_39), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_i0_i1 = tmpvar_42;
  frag.xyz = (frag.xyz + (tmpvar_42 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_43;
  tmpvar_43 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_43;
  mediump vec3 tmpvar_44;
  tmpvar_44 = (c.xyz + (((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_28)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_32)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_44;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  vec3 tmpvar_13;
  tmpvar_13.x = dot (tmpvar_2, tmpvar_6);
  tmpvar_13.y = dot (tmpvar_3, tmpvar_6);
  tmpvar_13.z = dot (tmpvar_4, tmpvar_6);
  vec3 tmpvar_14;
  tmpvar_14 = reflect (tmpvar_1, tmpvar_13);
  vec4 v_i0;
  v_i0.x = _SkyMatrix[0].x;
  v_i0.y = _SkyMatrix[1].x;
  v_i0.z = _SkyMatrix[2].x;
  ...
  v_i0_i1_i2.w = _SkyMatrix[3].z;
  vec4 tmpvar_15;
  tmpvar_15.xyz = ((v_i0.xyz * tmpvar_14.x) + ((v_i0_i1.xyz * tmpvar_14.y) + (v_i0_i1_i2.xyz * tmpvar_14.z)));
  tmpvar_15.w = ((7.0 + tmpvar_12) - (_Shininess * tmpvar_12));
  vec4 tmpvar_16;
  tmpvar_16 = textureCubeLod (_SpecCubeIBL, tmpvar_15.xyz, tmpvar_15.w);
  float tmpvar_17;
  ...
  v_i0_i1_i2_i0.w = _SkyMatrix[3].z;
  vec4 tmpvar_19;
  tmpvar_19 = textureCube (_DiffCubeIBL, ((v_i0_i0.xyz * dot (tmpvar_2, tmpvar_6)) + ((v_i0_i1_i0.xyz * dot (tmpvar_3, tmpvar_6)) + (v_i0_i1_i2_i0.xyz * dot (tmpvar_4, tmpvar_6)))));
  float tmpvar_20;
  ...
  glow = tmpvar_22;
  glow.xyz = (tmpvar_22.xyz * _GlowColor.xyz);
  glow.xyz = (glow.xyz * _GlowStrength);
  glow.w = (tmpvar_22.w * _EmissionLM);
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  c = vec4(0.0, 0.0, 0.0, 0.0);
  vec4 tmpvar_23;
  tmpvar_23 = texture2D (unity_Lightmap, xlv_TEXCOORD5);
  c.xyz = (diff.xyz * ((8.0 * tmpvar_23.w) * tmpvar_23.xyz));
  c.w = diff.w;
  c.xyz = (c.xyz + (((((tmpvar_16.xyz * dot (vec2(0.7532, 0.2468), tmpvar_18)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  fresnel_i0 = _Fresnel;
  float tmpvar_14;
  tmpvar_14 = (1.0 - clamp (dot (N, xlv_TEXCOORD1), 0.0, 1.0));
  spec.xyz = (spec.xyz * ((_SpecColor.xyz * (specIntensity * mix (1.0, (tmpvar_14 * (tmpvar_14 * tmpvar_14)), (fresnel_i0 * 0.9)))) * _ExposureIBL.w));
  mediump float tmpvar_15;
  mediump float shininess;
  shininess = _Shininess;
  mediump float tmpvar_16;
  tmpvar_16 = (1.0 - spec.w);
  mediump float tmpvar_17;
  tmpvar_17 = (1.0 - (tmpvar_16 * tmpvar_16));
  tmpvar_15 = ((7.0 + tmpvar_17) - (shininess * tmpvar_17));
  mediump vec3 tmpvar_18;
  tmpvar_18.x = dot (tmpvar_2, tmpvar_9);
  tmpvar_18.y = dot (tmpvar_3, tmpvar_9);
  tmpvar_18.z = dot (tmpvar_4, tmpvar_9);
  highp float glossLod_i0_i1;
  glossLod_i0_i1 = tmpvar_15;
  mediump vec4 spec_i0;
  mediump vec4 lookup;
  highp vec4 tmpvar_19;
  tmpvar_19.xyz = reflect (tmpvar_1, tmpvar_18);
  tmpvar_19.w = glossLod_i0_i1;
  lookup = tmpvar_19;
  lowp vec4 tmpvar_20;
  tmpvar_20 = textureCubeLod (_SpecCubeIBL, lookup.xyz, lookup.w);
  spec_i0 = tmpvar_20;
  highp vec3 tmpvar_21;
  tmpvar_21.x = dot (tmpvar_2, N);
  tmpvar_21.y = dot (tmpvar_3, N);
  tmpvar_21.z = dot (tmpvar_4, N);
  N = tmpvar_21;
  mediump vec4 diff_i0;
  lowp vec4 tmpvar_22;
  ...
  glow = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_25;
  highp float tmpvar_26;
  tmpvar_26 = (glow.w * _EmissionLM);
  glow.w = tmpvar_26;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec3 tmpvar_27;
  ...
  tmpvar_29 = (c.xyz + (((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_29;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_18 = ((7.0 + tmpvar_20) - (shininess * tmpvar_20));
  mediump vec3 tmpvar_21;
  tmpvar_21.x = dot (tmpvar_2, tmpvar_10);
  tmpvar_21.y = dot (tmpvar_3, tmpvar_10);
  tmpvar_21.z = dot (tmpvar_4, tmpvar_10);
  highp vec3 tmpvar_22;
  ...
  tmpvar_25 = (spec_i0.w * spec_i0.w);
  mediump vec2 tmpvar_26;
  tmpvar_26.x = tmpvar_25;
  tmpvar_26.y = (spec_i0.w * tmpvar_25);
  highp vec3 tmpvar_27;
  vec4 v_i0_i0;
  v_i0_i0.x = _SkyMatrix[0].x;
  v_i0_i0.y = _SkyMatrix[1].x;
  ...
  v_i0_i1_i2_i0.z = _SkyMatrix[2].z;
  v_i0_i1_i2_i0.w = _SkyMatrix[3].z;
  tmpvar_27 = ((v_i0_i0.xyz * dot (tmpvar_2, tmpvar_13)) + ((v_i0_i1_i0.xyz * dot (tmpvar_3, tmpvar_13)) + (v_i0_i1_i2_i0.xyz * dot (tmpvar_4, tmpvar_13))));
  N = tmpvar_27;
  mediump vec4 diff_i0;
  lowp vec4 tmpvar_28;
  tmpvar_28 = textureCube (_DiffCubeIBL, tmpvar_27);
  diff_i0 = tmpvar_28;
  mediump float tmpvar_29;
  tmpvar_29 = (diff_i0.w * diff_i0.w);
  mediump vec2 tmpvar_30;
  tmpvar_30.x = tmpvar_29;
  tmpvar_30.y = (diff_i0.w * tmpvar_29);
  lowp vec4 tmpvar_31;
  tmpvar_31 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_31;
  highp vec3 tmpvar_32;
  tmpvar_32 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_32;
  highp vec3 tmpvar_33;
  tmpvar_33 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_33;
  highp float tmpvar_34;
  tmpvar_34 = (glow.w * _EmissionLM);
  glow.w = tmpvar_34;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec4 tmpvar_35;
  ...
  lowp vec3 tmpvar_36;
  tmpvar_36 = ((8.0 * tmpvar_35.w) * tmpvar_35.xyz);
  mediump vec3 tmpvar_37;
  tmpvar_37 = (diff.xyz * tmpvar_36);
  c.xyz = tmpvar_37;
  c.w = tmpvar_9;
  mediump vec3 tmpvar_38;
  tmpvar_38 = (c.xyz + (((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_26)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_30)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_38;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  vec4 tmpvar_25;
  tmpvar_25 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7);
  vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  vec3 tmpvar_26;
  tmpvar_26 = normalize (xlv_TEXCOORD5);
  float tmpvar_27;
  tmpvar_27 = clamp (dot (tmpvar_6, tmpvar_26), 0.0, 1.0);
  frag.xyz = ((((tmpvar_25.x * 2.0) * tmpvar_27) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_26))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_27), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_25.x) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + (((((tmpvar_18.xyz * dot (vec2(0.7532, 0.2468), tmpvar_20)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_21.xyz * dot (vec2(0.7532, 0.2468), tmpvar_23)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_32) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_33;
  tmpvar_33 = clamp (dot (tmpvar_9, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_33;
  highp vec3 tmpvar_34;
  tmpvar_34 = vec3(pow (specRefl, tmpvar_19));
  spec_i0_i1 = tmpvar_34;
  mediump vec3 tmpvar_35;
  tmpvar_35 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_32), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_35;
  frag.xyz = (frag.xyz + (tmpvar_35 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_36;
  tmpvar_36 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_36;
  mediump vec3 tmpvar_37;
...
void main ()
{
  ...
  mediump float tmpvar_40;
  tmpvar_40 = clamp (dot (tmpvar_9, tmpvar_39), 0.0, 1.0);
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_40) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_41;
  tmpvar_41 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_39))), 0.0, 1.0);
  specRefl = tmpvar_41;
  highp vec3 tmpvar_42;
  tmpvar_42 = vec3(pow (specRefl, tmpvar_21));
  spec_i0_i1 = tmpvar_42;
  mediump vec3 tmpvar_43;
  tmpvar_43 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_40), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_43;
  frag.xyz = (frag.xyz + (tmpvar_43 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_44;
  tmpvar_44 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_44;
  mediump vec3 tmpvar_45;
  tmpvar_45 = (c.xyz + (((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_28)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_32)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_45;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  vec3 tmpvar_25;
  tmpvar_25 = ((8.0 * tmpvar_24.w) * tmpvar_24.xyz);
  c.xyz = (diff.xyz * max (min (tmpvar_25, ((tmpvar_23.x * 2.0) * tmpvar_24.xyz)), (tmpvar_25 * tmpvar_23.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + (((((tmpvar_16.xyz * dot (vec2(0.7532, 0.2468), tmpvar_18)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec3 tmpvar_27;
  tmpvar_27 = min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x * 2.0)));
  mediump vec3 tmpvar_28;
  tmpvar_28 = (diff.xyz * tmpvar_27);
  c.xyz = tmpvar_28;
  c.w = diff.w;
...
void main ()
{
  ...
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  lowp vec4 tmpvar_35;
  tmpvar_35 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec4 tmpvar_36;
  ...
  lowp vec3 tmpvar_38;
  tmpvar_38 = max (min (tmpvar_37, ((tmpvar_35.x * 2.0) * tmpvar_36.xyz)), (tmpvar_37 * tmpvar_35.x));
  mediump vec3 tmpvar_39;
  tmpvar_39 = (diff.xyz * tmpvar_38);
  c.xyz = tmpvar_39;
  c.w = tmpvar_9;
  mediump vec3 tmpvar_40;
  tmpvar_40 = (c.xyz + (((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_26)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_30)) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_40;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  p.x = dot (tmpvar_9.xy, tmpvar_10);
  p.y = dot (p.yz, tmpvar_10);
  spec.xyz = (tmpvar_7.xyz * ((_SpecColor.xyz * sqrt (((0.05 + (0.95 * dot (p.xy, tmpvar_10))) * _SpecInt))) * _ExposureIBL.w));
  float tmpvar_11;
  float tmpvar_12;
  tmpvar_12 = (1.0 - tmpvar_7.w);
  float tmpvar_13;
  ...
  glow = tmpvar_20;
  glow.xyz = (tmpvar_20.xyz * _GlowColor.xyz);
  glow.xyz = (glow.xyz * _GlowStrength);
  glow.w = (tmpvar_20.w * _EmissionLM);
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  vec3 tmpvar_21;
  ...
  float tmpvar_22;
  tmpvar_22 = clamp (dot (tmpvar_6, tmpvar_21), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_22) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_21))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_22), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + (((((tmpvar_18.xyz * tmpvar_18.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * tmpvar_19.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow = tmpvar_29;
  highp vec3 tmpvar_30;
  tmpvar_30 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_30;
  highp vec3 tmpvar_31;
  tmpvar_31 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_31;
  highp float tmpvar_32;
  tmpvar_32 = (glow.w * _EmissionLM);
  glow.w = tmpvar_32;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  highp vec3 tmpvar_33;
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump vec3 tmpvar_34;
  tmpvar_34 = normalize (lightDir);
  mediump float tmpvar_35;
  tmpvar_35 = clamp (dot (tmpvar_9, tmpvar_34), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_35) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_36;
  tmpvar_36 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_34))), 0.0, 1.0);
  specRefl = tmpvar_36;
  highp vec3 tmpvar_37;
  tmpvar_37 = vec3(pow (specRefl, tmpvar_21));
  spec_i0_i1 = tmpvar_37;
  mediump vec3 tmpvar_38;
  tmpvar_38 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_35), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_i0_i1 = tmpvar_38;
  frag.xyz = (frag.xyz + (tmpvar_38 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_39;
  tmpvar_39 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_39;
  mediump vec3 tmpvar_40;
  tmpvar_40 = (c.xyz + (((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_40;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  v_i0_i1_i2_i0.w = _SkyMatrix[3].z;
  vec4 tmpvar_17;
  tmpvar_17 = textureCube (_DiffCubeIBL, ((v_i0_i0.xyz * dot (tmpvar_2, tmpvar_6)) + ((v_i0_i1_i0.xyz * dot (tmpvar_3, tmpvar_6)) + (v_i0_i1_i2_i0.xyz * dot (tmpvar_4, tmpvar_6)))));
  vec4 tmpvar_18;
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  vec4 tmpvar_19;
  tmpvar_19 = texture2D (unity_Lightmap, xlv_TEXCOORD5);
  c.xyz = (diff.xyz * ((8.0 * tmpvar_19.w) * tmpvar_19.xyz));
  c.w = diff.w;
  c.xyz = (c.xyz + (((((tmpvar_16.xyz * tmpvar_16.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_17.xyz * tmpvar_17.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  mediump vec3 p;
  float tmpvar_14;
  tmpvar_14 = (1.0 - clamp (dot (tmpvar_12, normalize (xlv_TEXCOORD1)), 0.0, 1.0));
  mediump vec3 tmpvar_15;
  tmpvar_15.x = 1.0;
  tmpvar_15.y = tmpvar_14;
  tmpvar_15.z = ((tmpvar_14 * tmpvar_14) * tmpvar_14);
  p = tmpvar_15;
  mediump vec2 tmpvar_16;
  tmpvar_16.x = (1.0 - fresnel_i0);
  tmpvar_16.y = fresnel_i0;
  p.x = dot (tmpvar_15.xy, tmpvar_16);
  p.y = dot (p.yz, tmpvar_16);
  spec.xyz = (spec.xyz * ((_SpecColor.xyz * sqrt (((0.05 + (0.95 * dot (p.xy, tmpvar_16))) * specIntensity))) * _ExposureIBL.w));
  mediump float tmpvar_17;
  mediump float shininess;
  shininess = _Shininess;
  mediump float tmpvar_18;
  ...
  tmpvar_20.x = dot (tmpvar_2, tmpvar_9);
  tmpvar_20.y = dot (tmpvar_3, tmpvar_9);
  tmpvar_20.z = dot (tmpvar_4, tmpvar_9);
  highp vec3 tmpvar_21;
  tmpvar_21 = reflect (tmpvar_1, tmpvar_20);
  vec4 v_i0;
  v_i0.x = _SkyMatrix[0].x;
  v_i0.y = _SkyMatrix[1].x;
  v_i0.z = _SkyMatrix[2].x;
  ...
  mediump vec4 lookup;
  highp vec4 tmpvar_22;
  tmpvar_22.xyz = ((v_i0.xyz * tmpvar_21.x) + ((v_i0_i1.xyz * tmpvar_21.y) + (v_i0_i1_i2.xyz * tmpvar_21.z)));
  tmpvar_22.w = glossLod_i0_i1;
  lookup = tmpvar_22;
  lowp vec4 tmpvar_23;
  tmpvar_23 = textureCubeLod (_SpecCubeIBL, lookup.xyz, lookup.w);
  ...
  v_i0_i1_i2_i0.z = _SkyMatrix[2].z;
  v_i0_i1_i2_i0.w = _SkyMatrix[3].z;
  tmpvar_24 = ((v_i0_i0.xyz * dot (tmpvar_2, tmpvar_12)) + ((v_i0_i1_i0.xyz * dot (tmpvar_3, tmpvar_12)) + (v_i0_i1_i2_i0.xyz * dot (tmpvar_4, tmpvar_12))));
  N = tmpvar_24;
  mediump vec4 diff_i0;
  lowp vec4 tmpvar_25;
  tmpvar_25 = textureCube (_DiffCubeIBL, tmpvar_24);
  ...
  tmpvar_32 = (diff.xyz * tmpvar_31);
  c.xyz = tmpvar_32;
  c.w = diff.w;
  mediump vec3 tmpvar_33;
  tmpvar_33 = (c.xyz + (((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_33;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  vec4 tmpvar_21;
  tmpvar_21 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7);
  vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  vec3 tmpvar_22;
  tmpvar_22 = normalize (xlv_TEXCOORD5);
  float tmpvar_23;
  tmpvar_23 = clamp (dot (tmpvar_6, tmpvar_22), 0.0, 1.0);
  frag.xyz = ((((tmpvar_21.x * 2.0) * tmpvar_23) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_22))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_23), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_21.x) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + (((((tmpvar_18.xyz * tmpvar_18.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * tmpvar_19.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_36) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_37;
  tmpvar_37 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_35))), 0.0, 1.0);
  specRefl = tmpvar_37;
  highp vec3 tmpvar_38;
  tmpvar_38 = vec3(pow (specRefl, tmpvar_21));
  spec_i0_i1 = tmpvar_38;
  mediump vec3 tmpvar_39;
  tmpvar_39 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_36), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_39;
  frag.xyz = (frag.xyz + (tmpvar_39 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_40;
  tmpvar_40 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_40;
...
void main ()
{
  ...
  c.xyz = (diff.xyz * max (min (tmpvar_21, ((tmpvar_19.x * 2.0) * tmpvar_20.xyz)), (tmpvar_21 * tmpvar_19.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + (((((tmpvar_16.xyz * tmpvar_16.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_17.xyz * tmpvar_17.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  lowp vec4 tmpvar_30;
  tmpvar_30 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec4 tmpvar_31;
  ...
  lowp vec3 tmpvar_33;
  tmpvar_33 = max (min (tmpvar_32, ((tmpvar_30.x * 2.0) * tmpvar_31.xyz)), (tmpvar_32 * tmpvar_30.x));
  mediump vec3 tmpvar_34;
  tmpvar_34 = (diff.xyz * tmpvar_33);
  c.xyz = tmpvar_34;
  c.w = diff.w;
  mediump vec3 tmpvar_35;
  tmpvar_35 = (c.xyz + (((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_35;
  gl_FragData[0] = c;
}
...
dp3_pp_sat r1.w, r5, r4
mov_pp r2.w, r0.x
pow r0, r1.w, r2.w
dp3_pp_sat r1.w, r5, r2
mul_pp_sat r0.y, r1.w, c15.x
...
dp3 r4.w, r1, r0
mul r5.xyz, r1, r4.w
mad r5.xyz, -r5, c14.x, r0
mul r0.xyz, r5.z, c2
mad r0.xyz, r5.y, c1, r0
mul_pp r1.yzw, r2.xxyz, r1.w
mul_pp r1.yzw, r1, c4.xxyz
mad_pp r4.xyz, r1.yzww, c14.x, r4
mul r1.yzw, r5.w, c2.xxyz
mad r0.xyz, r5.x, c0, r0
mad r5.xyz, r0.w, c1, r1.yzww
mad r1.xyz, r1.x, c0, r5
texld r1, r1, s4
mul_pp r5.z, r1.w, r1.w
mul_pp r5.w, r1, r5.z
mov_pp r0.w, r3
texldl r0, r0, s3
...
add r1.w, -r0, c13
mul_pp r2.xy, r2.wxzw, c14
add_pp r0.w, r2.x, r2.y
mul_pp r2.z, r1.w, r1.w
mul_pp r2.w, r1, r2.z
mov_pp r2.x, c9
add_pp r2.x, c13.w, -r2
mov_pp r2.y, c9.x
mov_pp r2.z, r1.w
mul_pp r2.zw, r2, r2.xyxy
mov_pp r3.y, r1.w
mov_pp r3.x, c13.w
mul_pp r3.xy, r2, r3
add_pp r3.x, r3, r3.y
...
add_pp r3.w, -r1, c14
pow_pp r0, c14.x, r3.w
dp3_pp r2.w, r5, r5
rsq_pp r0.y, r2.w
mul_pp r5.xyz, r0.y, r5
dp3_pp_sat r3.w, r2, r5
mov_pp r2.w, r0.x
pow r0, r3.w, r2.w
dp3_pp_sat r5.x, r2, r3
mul_pp_sat r0.y, r5.x, c15.x
mul_pp r0.w, r0.x, r0.y
mul_pp r0.xyz, r4, c6.w
mul_pp r1.xyz, r1, r0
mad r2.w, r2, c16.x, c16.y
...
mov_pp r4.x, r0
mov_pp r4.y, r2.x
mul_pp r2.xyz, r3, c16.z
mov r0.x, v2.w
mov r0.z, v4.w
mov r0.y, v3.w
dp3 r3.w, r4.wxyw, r0
mul r4.xyz, r4.wxyw, r3.w
mad r0.xyz, -r4, c14.x, r0
mul_pp r4.x, r6, r5
mul r5.xyz, r0.z, c2
mad r5.xyz, r0.y, c1, r5
texld r3, v0, s0
mul_pp r3, r3, c7
mul_pp r3.xyz, r3, c6.w
mul_pp r4.xyz, r3, r4.x
mul_pp r4.xyz, r4, c4
mad_pp r4.xyz, r4, c14.x, r2
mul r2.xyz, r2.w, c2
mad r2.xyz, r0.w, c1, r2
mad r2.xyz, r4.w, c0, r2
mad r0.xyz, r0.x, c0, r5
texld r2, r2, s4
mov_pp r0.w, r1
texldl r0, r0, s3
mul_pp r5.x, r0.w, r0.w
...
mad_pp r2.xyz, r1, c6.y, r2
mul_pp r0.w, r0, c13.x
mul_pp r1.xyz, r3, r0.w
mul_pp r0.xyz, r0, c11
mad_pp r0.xyz, r0, c12.x, r1
mad_pp r0.xyz, r0, c6.w, r2
mad_pp r1.xyz, r3, v6, r4
add_pp oC0.xyz, r1, r0
mov_pp oC0.w, r3
"
}
...
mad r3.xyz, r1.x, c0, r2
mov_pp r0.w, c9.x
mov_pp r1.y, r0.x
mul_pp r0.y, r0.x, r0
mov_pp r1.x, c13.w
mul_pp r1.xy, r0.zwzw, r1
add_pp r1.x, r1, r1.y
mul_pp r0.xy, r0, r0.zwzw
add_pp r1.y, r0.x, r0
mul_pp r1.xy, r1, r0.zwzw
add_pp r1.x, r1, r1.y
texld r0, v0, s2
add_pp r0.w, -r0, c13
mad_pp r1.x, r1, c14, c14.y
mad_pp r0.w, -r0, r0, c13
mad_pp r0.w, -r0, c8.x, r0
add_pp r3.w, r0, c13.z
texldl r3, r3, s3
...
mul r2.xyz, r4, r1.w
mul r3.xyz, r3.x, v1
mad r0.xyz, -r2, c13.y, r0
dp3_sat r1.w, r1, r3
mul r1.xyz, r0.z, c2
mad r1.xyz, r0.y, c1, r1
add r0.z, -r1.w, c14.x
mad r3.xyz, r0.x, c0, r1
...
mov_pp r1.w, r0.z
mov_pp r1.z, c14.x
mul_pp r1.zw, r0.xyxy, r1
add_pp r1.z, r1, r1.w
add_pp r1.w, r1.x, r1.y
mul_pp r0.xy, r1.zwzw, r0
add_pp r0.y, r0.x, r0
texld r1, v0, s2
add_pp r0.x, -r1.w, c14
mad_pp r0.y, r0, c14, c14.z
mad_pp r0.x, -r0, r0, c14
mad_pp r0.x, -r0, c8, r0
add_pp r3.w, r0.x, c13
texldl r3, r3, s3
mul_pp r2.xyz, r3, r3.w
mul_pp r0.y, r0, c7.x
rsq_pp r0.y, r0.y
...
void main ()
{
  ...
  vec3 p;
  float tmpvar_4;
  tmpvar_4 = (1.0 - clamp (dot (tmpvar_2, normalize (xlv_TEXCOORD1)), 0.0, 1.0));
  vec3 tmpvar_5;
  tmpvar_5.x = 1.0;
  tmpvar_5.y = tmpvar_4;
  ...
  float tmpvar_7;
  tmpvar_7 = (1.0 - tmpvar_3.w);
  float tmpvar_8;
  tmpvar_8 = (1.0 - (tmpvar_7 * tmpvar_7));
  float tmpvar_9;
  tmpvar_9 = pow (2.0, (8.0 - ((7.0 + tmpvar_8) - (_Shininess * tmpvar_8))));
  vec4 tmpvar_10;
  tmpvar_10 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_10;
  glow.xyz = (tmpvar_10.xyz * _GlowColor.xyz);
  glow.xyz = (glow.xyz * _GlowStrength);
  glow.w = (tmpvar_10.w * _EmissionLM);
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  float atten;
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  vec3 tmpvar_11;
  tmpvar_11 = normalize (normalize (xlv_TEXCOORD2));
  float tmpvar_12;
  tmpvar_12 = clamp (dot (tmpvar_2, tmpvar_11), 0.0, 1.0);
  frag.xyz = ((((atten * 2.0) * tmpvar_12) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_2, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_11))), 0.0, 1.0), tmpvar_9)) * clamp ((10.0 * tmpvar_12), 0.0, 1.0)) * _LightColor0.xyz) * atten) * 0.5) * (spec.xyz * ((tmpvar_9 * 0.159155) + 0.31831))));
  c = frag;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  fresnel_i0 = _Fresnel;
  float tmpvar_7;
  tmpvar_7 = (1.0 - clamp (dot (N, xlv_TEXCOORD1), 0.0, 1.0));
  ...
  tmpvar_10 = pow (2.0, (8.0 - ((7.0 + tmpvar_9) - (shininess * tmpvar_9))));
  highp float gloss;
  gloss = tmpvar_10;
  highp vec3 tmpvar_11;
  tmpvar_11 = (spec.xyz * ((gloss * 0.159155) + 0.31831));
  tmpvar_2 = tmpvar_11;
  lowp vec4 tmpvar_12;
  ...
  tmpvar_18 = vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3));
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_LightTexture0, tmpvar_18);
  ...
  specRefl = tmpvar_21;
  highp vec3 tmpvar_22;
  tmpvar_22 = vec3(pow (specRefl, tmpvar_10));
...
void main ()
{
  ...
  highp vec2 tmpvar_20;
  tmpvar_20 = vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3));
  lowp vec4 tmpvar_21;
...
void main ()
{
  ...
  float tmpvar_12;
  tmpvar_12 = clamp (dot (tmpvar_2, tmpvar_11), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_12) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_2, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_11))), 0.0, 1.0), tmpvar_9)) * clamp ((10.0 * tmpvar_12), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_9 * 0.159155) + 0.31831))));
  c = frag;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  frag.xyz = (((2.0 * tmpvar_17) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_18;
  tmpvar_18 = clamp (dot (tmpvar_1, normalize ((viewDir + lightDir_i0))), 0.0, 1.0);
  specRefl = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = vec3(pow (specRefl, tmpvar_10));
  spec_i0_i1 = tmpvar_19;
  mediump vec3 tmpvar_20;
  tmpvar_20 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_17), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
...
void main ()
{
  ...
  tmpvar_17 = normalize (xlv_TEXCOORD1);
  lowp vec4 tmpvar_18;
  tmpvar_18 = texture2D (_LightTexture0, ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.5));
  highp vec3 LightCoord_i0;
  LightCoord_i0 = xlv_TEXCOORD3.xyz;
  highp vec2 tmpvar_19;
  tmpvar_19 = vec2(dot (LightCoord_i0, LightCoord_i0));
  lowp vec4 tmpvar_20;
  ...
  viewDir = tmpvar_17;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_18.w) * tmpvar_20.w);
  mediump vec3 spec_i0_i1;
  highp float specRefl;
  mediump vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  ...
  tmpvar_23 = vec3(pow (specRefl, tmpvar_10));
  spec_i0_i1 = tmpvar_23;
  mediump vec3 tmpvar_24;
...
void main ()
{
  ...
  tmpvar_19 = normalize (xlv_TEXCOORD1);
  lowp vec4 tmpvar_20;
  tmpvar_20 = texture2D (_LightTexture0, ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.5));
  highp vec3 LightCoord_i0;
  LightCoord_i0 = xlv_TEXCOORD3.xyz;
  ...
  viewDir = tmpvar_19;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_20.w) * tmpvar_22.w);
  mediump vec3 spec_i0_i1;
  highp float specRefl;
  mediump vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
...
void main ()
{
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_18) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_19;
  tmpvar_19 = clamp (dot (tmpvar_1, normalize ((viewDir + lightDir_i0))), 0.0, 1.0);
  specRefl = tmpvar_19;
  highp vec3 tmpvar_20;
  tmpvar_20 = vec3(pow (specRefl, tmpvar_10));
  spec_i0_i1 = tmpvar_20;
  mediump vec3 tmpvar_21;
  tmpvar_21 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_18), 0.0, 1.0)) * _LightColor0.xyz) * atten) * 0.5);
...
void main ()
{
  ...
  tmpvar_18 = normalize (xlv_TEXCOORD1);
  lowp vec4 tmpvar_19;
  tmpvar_19 = texture2D (_LightTexture0, xlv_TEXCOORD3);
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump vec3 viewDir;
  viewDir = tmpvar_18;
