...
void main ()
{
  ...
  tmpvar_10 = (c.xyz + ((((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_10;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_13 = (c.xyz + (diff.xyz * xlv_TEXCOORD2));
  c.xyz = tmpvar_13;
  mediump vec3 tmpvar_14;
  tmpvar_14 = (c.xyz + ((((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_8)) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_14;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  vec4 tmpvar_7;
  tmpvar_7 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_7;
  glow.xyz = (tmpvar_7.xyz * _GlowColor.xyz);
  glow.xyz = (glow.xyz * _GlowStrength);
  glow.w = (tmpvar_7.w * _EmissionLM);
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  c = vec4(0.0, 0.0, 0.0, 0.0);
  vec4 tmpvar_8;
  tmpvar_8 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  c.xyz = (diff.xyz * ((8.0 * tmpvar_8.w) * tmpvar_8.xyz));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_4.xyz * dot (vec2(0.7532, 0.2468), tmpvar_6)) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  mediump vec3 tmpvar_10;
  tmpvar_10 = (diff.xyz * tmpvar_9);
  c.xyz = tmpvar_10;
  c.w = diff.w;
  mediump vec3 tmpvar_11;
  tmpvar_11 = (c.xyz + ((((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_11;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_16 = (c.xyz + ((((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_8)) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_16;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = frag;
  mediump vec3 tmpvar_14;
  tmpvar_14 = (c.xyz + (diff.xyz * xlv_TEXCOORD2));
  c.xyz = tmpvar_14;
  mediump vec3 tmpvar_15;
  tmpvar_15 = (c.xyz + ((((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_8)) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_15;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  vec4 tmpvar_8;
  tmpvar_8 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  vec4 tmpvar_9;
  tmpvar_9 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  vec3 tmpvar_10;
  tmpvar_10 = ((8.0 * tmpvar_9.w) * tmpvar_9.xyz);
  c.xyz = (diff.xyz * max (min (tmpvar_10, ((tmpvar_8.x * 2.0) * tmpvar_9.xyz)), (tmpvar_10 * tmpvar_8.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_4.xyz * dot (vec2(0.7532, 0.2468), tmpvar_6)) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec3 tmpvar_9;
  tmpvar_9 = min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2).x * 2.0)));
  mediump vec3 tmpvar_10;
  tmpvar_10 = (diff.xyz * tmpvar_9);
  c.xyz = tmpvar_10;
  c.w = diff.w;
...
void main ()
{
  ...
  tmpvar_18 = (c.xyz + ((((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_8)) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_18;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow = tmpvar_7;
  highp vec3 tmpvar_8;
  tmpvar_8 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_8;
  highp vec3 tmpvar_9;
  tmpvar_9 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_9;
  highp float tmpvar_10;
  tmpvar_10 = (glow.w * _EmissionLM);
  glow.w = tmpvar_10;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  mediump vec3 lightDir;
  lightDir = _WorldSpaceLightPos0.xyz;
  ...
  c = frag;
  mediump vec3 tmpvar_11;
  tmpvar_11 = (c.xyz + (diff.xyz * xlv_TEXCOORD2));
  c.xyz = tmpvar_11;
  mediump vec3 tmpvar_12;
  tmpvar_12 = (c.xyz + ((((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_12;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_5 = texture2D (_Illum, xlv_TEXCOORD0);
  glow = tmpvar_5;
  glow.xyz = (tmpvar_5.xyz * _GlowColor.xyz);
  glow.xyz = (glow.xyz * _GlowStrength);
  glow.w = (tmpvar_5.w * _EmissionLM);
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  c = vec4(0.0, 0.0, 0.0, 0.0);
  vec4 tmpvar_6;
  tmpvar_6 = texture2D (unity_Lightmap, xlv_TEXCOORD1);
  c.xyz = (diff.xyz * ((8.0 * tmpvar_6.w) * tmpvar_6.xyz));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_4.xyz * tmpvar_4.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.w = diff.w;
  mediump vec3 tmpvar_14;
  tmpvar_14 = (c.xyz + ((((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_14;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = frag;
  mediump vec3 tmpvar_12;
  tmpvar_12 = (c.xyz + (diff.xyz * xlv_TEXCOORD2));
  c.xyz = tmpvar_12;
  mediump vec3 tmpvar_13;
  tmpvar_13 = (c.xyz + ((((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  c.xyz = tmpvar_13;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * max (min (tmpvar_8, ((tmpvar_6.x * 2.0) * tmpvar_7.xyz)), (tmpvar_8 * tmpvar_6.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_4.xyz * tmpvar_4.w) * diff.xyz) * _ExposureIBL.x) + (glow.xyz * _ExposureIBL.w)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
  lowp vec4 tmpvar_11;
  tmpvar_11 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD2);
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec4 tmpvar_12;
  ...
  lowp vec3 tmpvar_14;
  tmpvar_14 = max (min (tmpvar_13, ((tmpvar_11.x * 2.0) * tmpvar_12.xyz)), (tmpvar_13 * tmpvar_11.x));
  mediump vec3 tmpvar_15;
  tmpvar_15 = (diff.xyz * tmpvar_14);
  c.xyz = tmpvar_15;
  c.w = diff.w;
...
Vector 7 [_Color]
Vector 8 [_GlowColor]
Float 9 [_GlowStrength]
Float 10 [_EmissionLM]
...
dcl_cube s1
dcl_2d s2
def c11, 0.75341797, 0.24682617, 2.00000000, 0
dcl_texcoord0 v0.xy
...
dcl_2d s2
dcl_2d s3
def c9, 0.75341797, 0.24682617, 8.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xy
dp3 r0.w, r0, r0
rsq r0.w, r0.w
...
dcl_2d s3
dcl_2d s4
def c9, 0.75341797, 0.24682617, 8.00000000, 2.00000000
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xy
dcl_texcoord2 v2
dp3 r0.w, r0, r0
...
dcl_2d s3
dcl_2d s4
def c9, 8.00000000, 2.00000000, 0, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xy
dcl_texcoord2 v2
dp3 r0.w, r0, r0
...
void main ()
{
  ...
  glow = tmpvar_4;
  highp vec3 tmpvar_5;
  tmpvar_5 = (glow.xyz * _GlowColor.xyz);
  glow.xyz = tmpvar_5;
  highp vec3 tmpvar_6;
  tmpvar_6 = (glow.xyz * _GlowStrength);
  glow.xyz = tmpvar_6;
  highp float tmpvar_7;
  tmpvar_7 = (glow.w * _EmissionLM);
  glow.w = tmpvar_7;
  glow.xyz = (glow.xyz + (diff.xyz * glow.w));
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD4.z > 0.0)) * tmpvar_9.w) * tmpvar_11.w);
  mediump vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  frag.xyz = ((((atten * 2.0) * clamp (dot (tmpvar_1, lightDir_i0), 0.0, 1.0)) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD4.z > 0.0)) * tmpvar_10.w) * tmpvar_12.w);
  mediump vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  frag.xyz = ((((atten * 2.0) * clamp (dot (tmpvar_1, normalize (lightDir_i0)), 0.0, 1.0)) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  lowp vec4 tmpvar_11;
  tmpvar_11 = textureCube (_LightTexture0, xlv_TEXCOORD4);
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump float atten;
...
void main ()
{
  ...
  lightDir = xlv_TEXCOORD2;
  lowp vec4 tmpvar_8;
  tmpvar_8 = texture2D (_LightTexture0, xlv_TEXCOORD4);
  mediump vec3 lightDir_i0;
  lightDir_i0 = lightDir;
  mediump float atten;
  atten = tmpvar_8.w;
