...
void main ()
{
  ...
  tmpvar_10 = (c.xyz + (diff.xyz * xlv_TEXCOORD5));
  c.xyz = tmpvar_10;
  mediump vec3 tmpvar_11;
  tmpvar_11 = (c.xyz + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x));
  c.xyz = tmpvar_11;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_12 = (c.xyz + (diff.xyz * xlv_TEXCOORD5));
  c.xyz = tmpvar_12;
  mediump vec3 tmpvar_13;
  tmpvar_13 = (c.xyz + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_11)) * diff.xyz) * _ExposureIBL.x));
  c.xyz = tmpvar_13;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_14 = (c.xyz + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_10)) * diff.xyz) * _ExposureIBL.x));
  c.xyz = tmpvar_14;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = frag;
  mediump vec3 tmpvar_11;
  tmpvar_11 = (c.xyz + (diff.xyz * xlv_TEXCOORD5));
  c.xyz = tmpvar_11;
  mediump vec3 tmpvar_12;
...
void main ()
{
  ...
  c = frag;
  mediump vec3 tmpvar_13;
  tmpvar_13 = (c.xyz + (diff.xyz * xlv_TEXCOORD5));
  c.xyz = tmpvar_13;
  mediump vec3 tmpvar_14;
  tmpvar_14 = (c.xyz + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_11)) * diff.xyz) * _ExposureIBL.x));
  c.xyz = tmpvar_14;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec3 tmpvar_9;
  tmpvar_9 = min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD5).x * 2.0)));
  mediump vec3 tmpvar_10;
  tmpvar_10 = (diff.xyz * tmpvar_9);
  c.xyz = tmpvar_10;
  c.w = diff.w;
...
void main ()
{
  ...
  tmpvar_16 = (c.xyz + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_10)) * diff.xyz) * _ExposureIBL.x));
  c.xyz = tmpvar_16;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  vec4 tmpvar_4;
  tmpvar_4 = texture2D (unity_Lightmap, xlv_TEXCOORD4);
  c.xyz = (diff.xyz * ((8.0 * tmpvar_4.w) * tmpvar_4.xyz));
  c.w = diff.w;
  c.xyz = (c.xyz + (((tmpvar_3.xyz * tmpvar_3.w) * diff.xyz) * _ExposureIBL.x));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * max (min (tmpvar_6, ((tmpvar_4.x * 2.0) * tmpvar_5.xyz)), (tmpvar_6 * tmpvar_4.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + (((tmpvar_3.xyz * tmpvar_3.w) * diff.xyz) * _ExposureIBL.x));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.w = diff.w;
  mediump vec3 tmpvar_14;
  tmpvar_14 = (c.xyz + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x));
  c.xyz = tmpvar_14;
  gl_FragData[0] = c;
}
...
def c8, 0.75341797, 0.24682617, 0, 0
dcl_texcoord0 v0.xy
...
def c7, 0.75341797, 0.24682617, 0, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2.xyz
dcl_texcoord3 v3.xyz
