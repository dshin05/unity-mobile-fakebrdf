...
void main ()
{
  ...
  float tmpvar_26;
  tmpvar_26 = clamp (dot (tmpvar_7, tmpvar_25), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_26) * tmpvar_5) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_7, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_25))), 0.0, 1.0), tmpvar_15)) * clamp ((10.0 * tmpvar_26), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_15 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (tmpvar_5 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_22.xyz * dot (vec2(0.7532, 0.2468), tmpvar_24)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  frag.xyz = (((2.0 * tmpvar_28) * tmpvar_13) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_29;
  tmpvar_29 = clamp (dot (tmpvar_9, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_29;
  highp vec3 tmpvar_30;
  tmpvar_30 = vec3(pow (specRefl, tmpvar_20));
  spec_i0_i1 = tmpvar_30;
  mediump vec3 tmpvar_31;
  tmpvar_31 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_28), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_i0_i1 = tmpvar_31;
  frag.xyz = (frag.xyz + (tmpvar_31 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_32;
  tmpvar_32 = (c.xyz + (tmpvar_13 * xlv_TEXCOORD6));
  c.xyz = tmpvar_32;
...
void main ()
{
  ...
  tmpvar_36 = clamp (dot (tmpvar_10, tmpvar_35), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_36) * tmpvar_9) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_37;
  tmpvar_37 = clamp (dot (tmpvar_10, normalize ((viewDir + tmpvar_35))), 0.0, 1.0);
  specRefl = tmpvar_37;
  ...
  frag.xyz = (frag.xyz + (tmpvar_39 * tmpvar_11));
  c = frag;
  mediump vec3 tmpvar_40;
  tmpvar_40 = (c.xyz + (tmpvar_9 * xlv_TEXCOORD6));
  c.xyz = tmpvar_40;
  mediump vec3 tmpvar_41;
  tmpvar_41 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_29)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_33)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_41;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = ((diff.xyz * tmpvar_5.w) * ((8.0 * tmpvar_22.w) * tmpvar_22.xyz));
  c.w = diff.w;
...
void main ()
{
  ...
  mediump vec3 tmpvar_33;
  tmpvar_33 = ((diff.xyz * diff.w) * tmpvar_32);
  c.xyz = tmpvar_33;
  c.w = tmpvar_9;
...
void main ()
{
  ...
  frag.xyz = ((((tmpvar_25.x * 2.0) * tmpvar_27) * tmpvar_5) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_7, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_26))), 0.0, 1.0), tmpvar_15)) * clamp ((10.0 * tmpvar_27), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_25.x) * 0.5) * (spec.xyz * ((tmpvar_15 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (tmpvar_5 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_22.xyz * dot (vec2(0.7532, 0.2468), tmpvar_24)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump float tmpvar_29;
  tmpvar_29 = clamp (dot (tmpvar_9, lightDir), 0.0, 1.0);
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_29) * tmpvar_13) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_30;
  tmpvar_30 = clamp (dot (tmpvar_9, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_30;
  highp vec3 tmpvar_31;
  tmpvar_31 = vec3(pow (specRefl, tmpvar_20));
  spec_i0_i1 = tmpvar_31;
  mediump vec3 tmpvar_32;
  tmpvar_32 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_29), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_32;
  frag.xyz = (frag.xyz + (tmpvar_32 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_33;
  tmpvar_33 = (c.xyz + (tmpvar_13 * xlv_TEXCOORD6));
  c.xyz = tmpvar_33;
  mediump vec3 tmpvar_34;
  tmpvar_34 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_34;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  mediump float tmpvar_37;
  tmpvar_37 = clamp (dot (tmpvar_10, tmpvar_36), 0.0, 1.0);
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_37) * tmpvar_9) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_38;
  tmpvar_38 = clamp (dot (tmpvar_10, normalize ((viewDir + tmpvar_36))), 0.0, 1.0);
  specRefl = tmpvar_38;
  ...
  frag.xyz = (frag.xyz + (tmpvar_40 * tmpvar_11));
  c = frag;
  mediump vec3 tmpvar_41;
  tmpvar_41 = (c.xyz + (tmpvar_9 * xlv_TEXCOORD6));
  c.xyz = tmpvar_41;
  mediump vec3 tmpvar_42;
  tmpvar_42 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_29)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_33)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_42;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = ((diff.xyz * tmpvar_5.w) * max (min (tmpvar_24, ((tmpvar_22.x * 2.0) * tmpvar_23.xyz)), (tmpvar_24 * tmpvar_22.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_16.xyz * dot (vec2(0.7532, 0.2468), tmpvar_18)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  mediump vec3 tmpvar_35;
  tmpvar_35 = ((diff.xyz * diff.w) * tmpvar_34);
  c.xyz = tmpvar_35;
  c.w = tmpvar_9;
  mediump vec3 tmpvar_36;
...
void main ()
{
  ...
  float tmpvar_22;
  tmpvar_22 = clamp (dot (tmpvar_7, tmpvar_21), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_22) * tmpvar_6) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_7, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_21))), 0.0, 1.0), tmpvar_15)) * clamp ((10.0 * tmpvar_22), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_15 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (tmpvar_6 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_19.xyz * tmpvar_19.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_20.xyz * tmpvar_20.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  specRefl = tmpvar_33;
  highp vec3 tmpvar_34;
  tmpvar_34 = vec3(pow (specRefl, tmpvar_22));
...
void main ()
{
  ...
  c.xyz = ((diff.xyz * tmpvar_5.w) * ((8.0 * tmpvar_18.w) * tmpvar_18.xyz));
  c.w = diff.w;
...
void main ()
{
  ...
  tmpvar_28 = ((diff.xyz * diff.w) * tmpvar_27);
  c.xyz = tmpvar_28;
  c.w = diff.w;
...
void main ()
{
  ...
  frag.xyz = ((((tmpvar_21.x * 2.0) * tmpvar_23) * tmpvar_6) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_7, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_22))), 0.0, 1.0), tmpvar_15)) * clamp ((10.0 * tmpvar_23), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_21.x) * 0.5) * (spec.xyz * ((tmpvar_15 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (tmpvar_6 * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_19.xyz * tmpvar_19.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_20.xyz * tmpvar_20.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump vec3 tmpvar_32;
  tmpvar_32 = normalize (lightDir);
  mediump float tmpvar_33;
  tmpvar_33 = clamp (dot (tmpvar_9, tmpvar_32), 0.0, 1.0);
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_33) * tmpvar_13) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_34;
  tmpvar_34 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_32))), 0.0, 1.0);
  specRefl = tmpvar_34;
  highp vec3 tmpvar_35;
  tmpvar_35 = vec3(pow (specRefl, tmpvar_22));
  spec_i0_i1 = tmpvar_35;
  mediump vec3 tmpvar_36;
  ...
  tmpvar_38 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_38;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = ((diff.xyz * tmpvar_5.w) * max (min (tmpvar_20, ((tmpvar_18.x * 2.0) * tmpvar_19.xyz)), (tmpvar_20 * tmpvar_18.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_16.xyz * tmpvar_16.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_17.xyz * tmpvar_17.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_30 = ((diff.xyz * diff.w) * tmpvar_29);
  c.xyz = tmpvar_30;
  c.w = diff.w;
  mediump vec3 tmpvar_31;
...
add_pp r1.x, r0, r0.y
texld r0, v0, s2
add_pp r1.y, -r0.w, c12
mad_pp r1.x, r1, c12.z, c12.w
mul_pp r0.w, r1.x, c8.x
mad_pp r1.w, -r1.y, r1.y, c12.y
mul_pp r1.xyz, r0.w, c5
mad_pp r0.w, -r1, c9.x, r1
add_pp r1.w, r0, c11.z
dp3_pp r0.w, v1, v1
rsq_pp r0.w, r0.w
mad_pp r5.xyz, r0.w, v1, r2
add_pp r0.w, -r1, c11
pow_pp r4, c11.x, r0.w
dp3_pp r2.w, r5, r5
rsq_pp r0.w, r2.w
mul_pp r5.xyz, r0.w, r5
dp3_pp_sat r2.w, r3, r5
mov_pp r5.y, r6.x
mov_pp r0.w, r4.x
pow r4, r2.w, r0.w
dp3_pp_sat r2.w, r3, r2
mul_pp r1.xyz, r1, c6.w
dp3_pp r5.x, r3, v2
mov r2.y, r4.x
mul_pp_sat r2.x, r2.w, c12
mul_pp r2.x, r2.y, r2
mul_pp r1.xyz, r0, r1
mad r3.w, r0, c13.x, c13.y
...
mov r6.y, v3.w
dp3 r4.w, r5, r6
mul r5.yzw, r5.xxyz, r4.w
mul_pp r4.xyz, r4, c13.z
mul_pp r3.xyz, r3, c4
mad_pp r3.xyz, r3, c11.x, r4
mad r4.xyz, -r5.yzww, c11.x, r6
mul r6.xyz, r4.z, c2
mad r6.xyz, r4.y, c1, r6
mul r5.yzw, r3.w, c2.xxyz
mad r5.yzw, r6.w, c1.xxyz, r5
mad r5.xyz, r5.x, c0, r5.yzww
mad r4.xyz, r4.x, c0, r6
texld r5, r5, s4
mov_pp r4.w, r1
texldl r4, r4, s3
mul_pp r6.z, r5.w, r5.w
mul_pp r6.x, r4.w, r4.w
mul_pp r6.w, r5, r6.z
mul_pp r6.zw, r6, c14.xyxy
add_pp r1.w, r6.z, r6
...
dp3 r0.w, r4, r0
mul r3.xyz, r4, r0.w
mad r0.xyz, -r3, c10.x, r0
add_pp r0.w, -r1, c10
mul r3.xyz, r0.z, c2
mad_pp r0.z, -r0.w, r0.w, c10.w
...
dp3_pp r0.y, v1, v1
rsq_pp r0.x, r0.y
mad_pp r5.xyz, r0.x, v1, r2
add_pp r2.w, -r3, c11
pow_pp r0, c11.x, r2.w
dp3_pp r1.w, r5, r5
rsq_pp r0.y, r1.w
mul_pp r5.xyz, r0.y, r5
dp3_pp_sat r2.w, r4, r5
mov_pp r1.w, r0.x
pow r0, r2.w, r1.w
dp3_pp_sat r5.x, r4, r2
mul_pp_sat r0.y, r5.x, c12.x
...
mul_pp r4.xyz, r5, r1.x
mul_pp r4.xyz, r4, c4
mov r0.x, v2.w
mov r0.z, v4.w
mov r0.y, v3.w
dp3 r5.w, r1.yzww, r0
mul r1.xzw, r1.yyzw, r5.w
mad r1.xzw, -r1, c11.x, r0.xyyz
mad_pp r4.xyz, r4, c11.x, r6
mul r6.xyz, r1.w, c2
mul r0.xyz, r4.w, c2
mad r0.xyz, r0.w, c1, r0
mad r0.xyz, r1.y, c0, r0
mad r6.xyz, r1.z, c1, r6
mad r1.xyz, r1.x, c0, r6
texld r0, r0, s4
...
mul_pp r3.xyz, r4, c6.w
add_pp r2.w, -r3, c11
pow_pp r0, c11.x, r2.w
dp3_pp r1.w, r5, r5
rsq_pp r0.y, r1.w
mul_pp r5.xyz, r0.y, r5
dp3_pp_sat r2.w, r1, r5
mov_pp r1.w, r0.x
pow r0, r2.w, r1.w
mul_pp r4.xyz, r2, r3
...
mad_pp r5.xyz, r5, c11.x, r6
mad r6.xyz, -r1, c11.x, r0
mul r1.xyz, r6.z, c2
mad r1.xyz, r6.y, c1, r1
mul r0.xyz, r5.w, c2
mad r0.xyz, r0.w, c1, r0
mad r0.xyz, r1.w, c0, r0
mad r1.xyz, r6.x, c0, r1
texld r0, r0, s4
...
mad_pp r0.y, -r0, r0, c10.w
mad_pp r0.y, -r0, c8.x, r0
add_pp r3.w, r0.y, c10.z
mad_pp r0.z, r0, c11.x, c11.y
...
void main ()
{
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_11) * (diff.xyz * tmpvar_1.w)) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  float tmpvar_11;
  tmpvar_11 = clamp (dot (tmpvar_2, tmpvar_10), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_11) * (diff.xyz * tmpvar_1.w)) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  frag.xyz = (((2.0 * tmpvar_13) * (diff.xyz * diff.w)) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_14) * (diff.xyz * diff.w)) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_15;
