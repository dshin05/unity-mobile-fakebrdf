...
void main ()
{
  ...
  float tmpvar_19;
  tmpvar_19 = clamp (dot (xlv_TEXCOORD3, tmpvar_18), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_19) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (xlv_TEXCOORD3, normalize ((normalize (xlv_TEXCOORD2) + tmpvar_18))), 0.0, 1.0), tmpvar_10)) * clamp ((10.0 * tmpvar_19), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_10 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = (c.xyz + ((((tmpvar_12.xyz * dot (vec2(0.7532, 0.2468), tmpvar_14)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_15.xyz * dot (vec2(0.7532, 0.2468), tmpvar_17)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_17 = clamp (dot (tmpvar_1, lightDir), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_17) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_18;
  tmpvar_18 = clamp (dot (tmpvar_1, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = vec3(pow (specRefl, tmpvar_11));
  spec_i0_i1 = tmpvar_19;
  mediump vec3 tmpvar_20;
  tmpvar_20 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_17), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_i0_i1 = tmpvar_20;
  frag.xyz = (frag.xyz + (tmpvar_20 * tmpvar_3));
  c = frag;
  mediump vec3 tmpvar_21;
  tmpvar_21 = (c.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = tmpvar_21;
...
void main ()
{
  ...
  tmpvar_31 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_19)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_23)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_31;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * ((8.0 * tmpvar_17.w) * tmpvar_17.xyz));
  c.w = diff.w;
...
void main ()
{
  ...
  frag.xyz = ((((tmpvar_18.x * 2.0) * tmpvar_20) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (xlv_TEXCOORD3, normalize ((normalize (xlv_TEXCOORD2) + tmpvar_19))), 0.0, 1.0), tmpvar_10)) * clamp ((10.0 * tmpvar_20), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_18.x) * 0.5) * (spec.xyz * ((tmpvar_10 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = (c.xyz + ((((tmpvar_12.xyz * dot (vec2(0.7532, 0.2468), tmpvar_14)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_15.xyz * dot (vec2(0.7532, 0.2468), tmpvar_17)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_18) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_19;
  ...
  spec_i0_i1 = tmpvar_20;
  mediump vec3 tmpvar_21;
  tmpvar_21 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_18), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_21;
  frag.xyz = (frag.xyz + (tmpvar_21 * tmpvar_3));
  c = frag;
  mediump vec3 tmpvar_22;
  tmpvar_22 = (c.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = tmpvar_22;
...
void main ()
{
  ...
  tmpvar_32 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_19)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_23)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_32;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * max (min (tmpvar_19, ((tmpvar_17.x * 2.0) * tmpvar_18.xyz)), (tmpvar_19 * tmpvar_17.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_11.xyz * dot (vec2(0.7532, 0.2468), tmpvar_13)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_14.xyz * dot (vec2(0.7532, 0.2468), tmpvar_16)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  float tmpvar_15;
  tmpvar_15 = clamp (dot (xlv_TEXCOORD3, tmpvar_14), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_15) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (xlv_TEXCOORD3, normalize ((normalize (xlv_TEXCOORD2) + tmpvar_14))), 0.0, 1.0), tmpvar_10)) * clamp ((10.0 * tmpvar_15), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_10 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = (c.xyz + ((((tmpvar_12.xyz * tmpvar_12.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_13.xyz * tmpvar_13.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  specRefl = tmpvar_23;
  highp vec3 tmpvar_24;
  tmpvar_24 = vec3(pow (specRefl, tmpvar_14));
  spec_i0_i1 = tmpvar_24;
  mediump vec3 tmpvar_25;
  tmpvar_25 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_22), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  ...
  c.xyz = tmpvar_26;
  mediump vec3 tmpvar_27;
  tmpvar_27 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_27;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * ((8.0 * tmpvar_13.w) * tmpvar_13.xyz));
  c.w = diff.w;
...
void main ()
{
  ...
  tmpvar_13 = textureCube (_DiffCubeIBL, ((v_i0_i0.xyz * tmpvar_2.x) + ((v_i0_i1_i0.xyz * tmpvar_2.y) + (v_i0_i1_i2_i0.xyz * tmpvar_2.z))));
  vec4 tmpvar_14;
  tmpvar_14 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD5);
  vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  vec3 tmpvar_15;
  ...
  frag.xyz = ((((tmpvar_14.x * 2.0) * tmpvar_16) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (xlv_TEXCOORD3, normalize ((normalize (xlv_TEXCOORD2) + tmpvar_15))), 0.0, 1.0), tmpvar_10)) * clamp ((10.0 * tmpvar_16), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_14.x) * 0.5) * (spec.xyz * ((tmpvar_10 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = (c.xyz + ((((tmpvar_12.xyz * tmpvar_12.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_13.xyz * tmpvar_13.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_23) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_24;
  tmpvar_24 = clamp (dot (tmpvar_1, normalize ((viewDir + tmpvar_22))), 0.0, 1.0);
  specRefl = tmpvar_24;
  highp vec3 tmpvar_25;
  tmpvar_25 = vec3(pow (specRefl, tmpvar_14));
  spec_i0_i1 = tmpvar_25;
  mediump vec3 tmpvar_26;
  tmpvar_26 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_23), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_26;
  frag.xyz = (frag.xyz + (tmpvar_26 * tmpvar_3));
  c = frag;
  mediump vec3 tmpvar_27;
  tmpvar_27 = (c.xyz + (diff.xyz * xlv_TEXCOORD4));
  c.xyz = tmpvar_27;
...
void main ()
{
  ...
  c.xyz = (diff.xyz * max (min (tmpvar_15, ((tmpvar_13.x * 2.0) * tmpvar_14.xyz)), (tmpvar_15 * tmpvar_13.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_11.xyz * tmpvar_11.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_12.xyz * tmpvar_12.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
dp3_pp r1.y, v2, v2
rsq_pp r1.x, r1.y
mad_pp r5.xyz, r1.x, v2, r2
add_pp r3.w, -r0, c12.y
pow_pp r1, c12.z, r3.w
dp3_pp r2.w, r5, r5
rsq_pp r1.y, r2.w
mul_pp r5.xyz, r1.y, r5
mov_pp r2.w, r1.x
dp3_pp_sat r3.w, v3, r5
pow r1, r3.w, r2.w
dp3_pp_sat r1.w, v3, r2
mul_pp_sat r1.y, r1.w, c12.w
mad r1.z, r2.w, c14.x, c14.y
mul r4.xyz, r0.z, c2
mad r5.xyz, r0.y, c1, r4
...
mul_pp r5.xy, r5, c14.zwzw
mul_pp r5.w, r0, r5.z
add_pp r0.w, r5.x, r5.y
mul_pp r1.xyz, r1, r0.w
mul_pp r5.xy, r5.zwzw, c14.zwzw
add_pp r0.w, r5.x, r5.y
mul_pp r1.xyz, r2, r1
...
mad_pp r0.xyz, r0, c5.y, r3
mul_pp r1.xyz, r2, r1
mad_pp oC0.xyz, r1, c11.z, r0
mov_pp oC0.w, r1
"
}
...
mul_pp r1.x, r1, r1.y
texldp r5.x, v5, s4
mad r4.xyz, r0.y, c1, r4
mul_pp r1.xyz, r1.x, c5
mul_pp r1.xyz, r5.x, r1
mul_pp r1.xyz, r1, r2
texld r2, v0, s0
mul_pp r2, r2, c8
mul_pp r0.y, r5.x, r1.w
mul_pp r2.xyz, r2, c7.w
mul_pp r5.xyz, r2, r0.y
mad r0.xyz, r0.x, c0, r4
mul_pp r4.xyz, r5, c5
mul_pp r1.xyz, r1, c13.w
mad_pp r4.xyz, r4, c12.z, r1
texld r1, r0, s3
...
mul_pp r4.xyz, r0, c7.w
mul_pp r1.xyz, r1, r4
mad_pp r0.w, -r0, r0, c13.x
mad_pp r0.y, -r0.w, c10.x, r0.w
add_pp r1.w, r0.y, c12.x
mul r4.xyz, r2.z, c2
mad r4.xyz, r2.y, c1, r4
dp3_pp r0.x, c4, c4
rsq_pp r0.x, r0.x
mul_pp r3.xyz, r0.x, c4
dp3_pp r0.y, v2, v2
rsq_pp r0.x, r0.y
mad_pp r5.xyz, r0.x, v2, r3
add_pp r3.w, -r1, c12.y
pow_pp r0, c12.z, r3.w
dp3_pp r2.w, r5, r5
rsq_pp r0.y, r2.w
...
dp3_pp_sat r3.w, v3, r5
pow r0, r3.w, r2.w
dp3_pp_sat r0.w, v3, r3
mul_pp_sat r0.y, r0.w, c12.w
...
texld r0, v0, s1
mul_pp r2.xyz, r0, r1
add_pp r0.x, -r0.w, c10
mad_pp r0.w, -r0.x, r0.x, c10.x
mul r1.xyz, r3.z, c2
...
texld r3, v0, s0
mul_pp r3, r3, c8
mad r2.xyz, r2.x, c0, r4
mul_pp r0.w, r5.x, r0
mul_pp r3.xyz, r3, c7.w
mul_pp r5.xyz, r3, r0.w
mul_pp r0.xyz, r0, c13.w
mul_pp r4.xyz, r5, c5
mad_pp r4.xyz, r4, c12.z, r0
texld r0, r2, s3
...
void main ()
{
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_10) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_15) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_16;
...
void main ()
{
  ...
  float tmpvar_10;
  tmpvar_10 = clamp (dot (xlv_TEXCOORD2, tmpvar_9), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_10) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
...
void main ()
{
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_13) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_14;
