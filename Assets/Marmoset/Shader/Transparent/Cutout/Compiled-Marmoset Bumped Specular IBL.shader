...
void main ()
{
  ...
  float tmpvar_25;
  tmpvar_25 = clamp (dot (tmpvar_6, tmpvar_24), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_25) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_24))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_25), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_18.xyz * dot (vec2(0.7532, 0.2468), tmpvar_20)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_21.xyz * dot (vec2(0.7532, 0.2468), tmpvar_23)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_27 = clamp (dot (tmpvar_9, lightDir), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_27) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_28;
  tmpvar_28 = clamp (dot (tmpvar_9, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_28;
  highp vec3 tmpvar_29;
  tmpvar_29 = vec3(pow (specRefl, tmpvar_19));
  spec_i0_i1 = tmpvar_29;
  mediump vec3 tmpvar_30;
  tmpvar_30 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_27), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
  spec_i0_i1 = tmpvar_30;
  frag.xyz = (frag.xyz + (tmpvar_30 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_31;
  tmpvar_31 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_31;
  mediump vec3 tmpvar_32;
  tmpvar_32 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_32;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_40 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_28)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_32)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_40;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * ((8.0 * tmpvar_22.w) * tmpvar_22.xyz));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_16.xyz * dot (vec2(0.7532, 0.2468), tmpvar_18)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_24 = (diff.xyz * tmpvar_23);
  c.xyz = tmpvar_24;
  c.w = diff.w;
  mediump vec3 tmpvar_25;
  tmpvar_25 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_25;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_33 = (diff.xyz * tmpvar_32);
  c.xyz = tmpvar_33;
  c.w = tmpvar_9;
  mediump vec3 tmpvar_34;
  tmpvar_34 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_26)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_30)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_34;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  frag.xyz = ((((tmpvar_24.x * 2.0) * tmpvar_26) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_25))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_26), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_24.x) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_18.xyz * dot (vec2(0.7532, 0.2468), tmpvar_20)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_21.xyz * dot (vec2(0.7532, 0.2468), tmpvar_23)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump float tmpvar_28;
  tmpvar_28 = clamp (dot (tmpvar_9, lightDir), 0.0, 1.0);
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_28) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_29;
  tmpvar_29 = clamp (dot (tmpvar_9, normalize ((viewDir + lightDir))), 0.0, 1.0);
  specRefl = tmpvar_29;
  highp vec3 tmpvar_30;
  tmpvar_30 = vec3(pow (specRefl, tmpvar_19));
  spec_i0_i1 = tmpvar_30;
  mediump vec3 tmpvar_31;
  tmpvar_31 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_28), 0.0, 1.0)) * _LightColor0.xyz) * atten_i0) * 0.5);
  spec_i0_i1 = tmpvar_31;
  frag.xyz = (frag.xyz + (tmpvar_31 * tmpvar_10));
  c = frag;
  mediump vec3 tmpvar_32;
  tmpvar_32 = (c.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = tmpvar_32;
  mediump vec3 tmpvar_33;
  tmpvar_33 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_33;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_41 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_28)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_32)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_41;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.xyz = (diff.xyz * max (min (tmpvar_24, ((tmpvar_22.x * 2.0) * tmpvar_23.xyz)), (tmpvar_24 * tmpvar_22.x)));
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_16.xyz * dot (vec2(0.7532, 0.2468), tmpvar_18)) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * dot (vec2(0.7532, 0.2468), tmpvar_21)) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c = vec4(0.0, 0.0, 0.0, 0.0);
  lowp vec3 tmpvar_23;
  tmpvar_23 = min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz), vec3((texture2DProj (_ShadowMapTexture, xlv_TEXCOORD6).x * 2.0)));
  mediump vec3 tmpvar_24;
  tmpvar_24 = (diff.xyz * tmpvar_23);
  c.xyz = tmpvar_24;
  c.w = diff.w;
...
void main ()
{
  ...
  mediump vec3 tmpvar_35;
  tmpvar_35 = (diff.xyz * tmpvar_34);
  c.xyz = tmpvar_35;
  c.w = tmpvar_9;
  mediump vec3 tmpvar_36;
  tmpvar_36 = (c.xyz + ((((spec_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_26)) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * dot (vec2(0.7532, 0.2468), tmpvar_30)) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_36;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  float tmpvar_21;
  tmpvar_21 = clamp (dot (tmpvar_6, tmpvar_20), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_21) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_20))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_21), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_18.xyz * tmpvar_18.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * tmpvar_19.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  mediump float tmpvar_31;
  tmpvar_31 = clamp (dot (tmpvar_9, tmpvar_30), 0.0, 1.0);
  frag.xyz = (((2.0 * tmpvar_31) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_32;
  tmpvar_32 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_30))), 0.0, 1.0);
  specRefl = tmpvar_32;
  highp vec3 tmpvar_33;
  tmpvar_33 = vec3(pow (specRefl, tmpvar_21));
  ...
  c.xyz = tmpvar_35;
  mediump vec3 tmpvar_36;
  tmpvar_36 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_36;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.w = diff.w;
  c.xyz = (c.xyz + ((((tmpvar_16.xyz * tmpvar_16.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_17.xyz * tmpvar_17.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  frag.xyz = ((((tmpvar_20.x * 2.0) * tmpvar_22) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_6, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_21))), 0.0, 1.0), tmpvar_14)) * clamp ((10.0 * tmpvar_22), 0.0, 1.0)) * _LightColor0.xyz) * tmpvar_20.x) * 0.5) * (spec.xyz * ((tmpvar_14 * 0.159155) + 0.31831))));
  c = frag;
  c.xyz = (frag.xyz + (diff.xyz * xlv_TEXCOORD6));
  c.xyz = (c.xyz + ((((tmpvar_18.xyz * tmpvar_18.w) * spec.xyz) * _ExposureIBL.y) + (((tmpvar_19.xyz * tmpvar_19.w) * diff.xyz) * _ExposureIBL.x)));
  gl_FragData[0] = c;
...
void main ()
{
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump vec3 tmpvar_31;
  tmpvar_31 = normalize (lightDir);
  mediump float tmpvar_32;
  tmpvar_32 = clamp (dot (tmpvar_9, tmpvar_31), 0.0, 1.0);
  frag.xyz = ((((atten_i0 * 2.0) * tmpvar_32) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_33;
  tmpvar_33 = clamp (dot (tmpvar_9, normalize ((viewDir + tmpvar_31))), 0.0, 1.0);
  specRefl = tmpvar_33;
  highp vec3 tmpvar_34;
  tmpvar_34 = vec3(pow (specRefl, tmpvar_21));
  spec_i0_i1 = tmpvar_34;
  mediump vec3 tmpvar_35;
  ...
  tmpvar_37 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_37;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  c.w = diff.w;
  mediump vec3 tmpvar_31;
  tmpvar_31 = (c.xyz + ((((spec_i0.xyz * spec_i0.w) * spec.xyz) * _ExposureIBL.y) + (((diff_i0.xyz * diff_i0.w) * diff.xyz) * _ExposureIBL.x)));
  c.xyz = tmpvar_31;
  gl_FragData[0] = c;
}
...
dcl_cube s3
dcl_cube s4
def c11, 2.00000000, -1.00000000, 7.00000000, 8.00000000
def c12, 10.00000000, 1.00000000, 0.95019531, 0.04998779
def c13, 0.15915494, 0.31830987, 0.50000000, 0
def c14, 0.75341797, 0.24682617, 0, 0
dcl_texcoord0 v0.xy
...
add_pp r1.x, r1, r1.y
texld r2, v0, s2
add_pp r0.w, -r2, c12.y
mad_pp r1.x, r1, c12.z, c12.w
mul_pp r4.w, r1.x, c8.x
mad_pp r0.w, -r0, r0, c12.y
...
add_pp r3.w, -r0, c11
pow_pp r1, c11.x, r3.w
dp3_pp r2.w, r4, r4
rsq_pp r1.y, r2.w
mul_pp r4.xyz, r1.y, r4
dp3_pp_sat r3.w, r0, r4
mov_pp r2.w, r1.x
pow r1, r3.w, r2.w
dp3_pp_sat r3.w, r0, r3
mul_pp_sat r1.y, r3.w, c12.x
...
mad_pp r4.xyz, r4, c11.x, r5
mad r5.xyz, -r1, c11.x, r0
mul r0.xyz, r5.z, c2
...
def c11, 0.75341797, 0.24682617, 0.95019531, 0.04998779
...
add r1.w, -r0, c10
mul_pp r2.xy, r2.wxzw, c11
add_pp r0.w, r2.x, r2.y
mul_pp r2.z, r1.w, r1.w
mul_pp r2.w, r1, r2.z
mov_pp r2.x, c9
add_pp r2.x, c10.w, -r2
mov_pp r2.y, c9.x
mov_pp r2.z, r1.w
mov_pp r3.y, r1.w
mov_pp r3.x, c10.w
...
add_pp r0.x, r0, r0.y
mad_pp r0.y, r0.x, c12.z, c12.w
texld r1, v0, s2
add_pp r0.x, -r1.w, c12.y
mul_pp r0.y, r0, c8.x
mul_pp r3.xyz, r0.y, c5
mad_pp r0.x, -r0, r0, c12.y
mad_pp r0.y, -r0.x, c9.x, r0.x
add_pp r3.w, r0.y, c11.z
dp3_pp r0.x, v5, v5
rsq_pp r0.x, r0.x
...
mov_pp r1.w, r0.x
pow r0, r2.w, r1.w
mul_pp_sat r0.y, r4.w, c12.x
mul_pp r0.w, r0.x, r0.y
mul_pp r0.xyz, r3, c6.w
mul_pp r3.xyz, r1, r0
texldp r6.x, v7, s5
mad r1.w, r1, c13.x, c13.y
...
dp3 r5.x, r1, r0
mul r5.xyz, r1, r5.x
mad r0.xyz, -r5, c11.x, r0
mad_pp r4.xyz, r6, c11.x, r4
mul r5.xyz, r1.w, c2
mad r5.xyz, r0.w, c1, r5
...
dcl_2d s5
dcl_2d s6
def c10, 8.00000000, 2.00000000, -1.00000000, 7.00000000
def c11, 0.75341797, 0.24682617, 1.00000000, 0
def c12, 0.95019531, 0.04998779, 0, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2
dcl_texcoord3 v3
...
dp3 r0.w, r4, r0
mul r3.xyz, r4, r0.w
mad r0.xyz, -r3, c10.y, r0
add_pp r0.w, -r1, c11.z
mul r3.xyz, r0.z, c2
mad_pp r0.z, -r0.w, r0.w, c11
...
mov_pp r0.x, r1.w
mul_pp r0.zw, r0.xyxy, r2
add_pp r2.y, r0.z, r0.w
mov_pp r0.y, r1.w
mov_pp r0.x, c11.z
mul_pp r0.xy, r2.zwzw, r0
add_pp r2.x, r0, r0.y
...
mul_pp r0.xy, r0.zwzw, r0
add_pp r0.x, r0, r0.y
mad_pp r0.x, r0, c12.z, c12.w
mul_pp r0.y, r0.x, c8.x
texld r2, v0, s2
add_pp r0.x, -r2.w, c12.y
rsq_pp r0.y, r0.y
rcp_pp r2.w, r0.y
mad_pp r0.x, -r0, r0, c12.y
mad_pp r0.y, -r0.x, c9.x, r0.x
...
texld r2, v0, s0
mul_pp r2, r2, c7
pow_pp r0, c11.x, r4.w
dp3_pp r1.w, r4, r4
rsq_pp r0.y, r1.w
mul_pp r4.xyz, r0.y, r4
dp3_pp_sat r4.x, r1, r4
mov_pp r1.w, r0.x
pow r0, r4.x, r1.w
mad r0.w, r1, c13.x, c13.y
mul_pp_sat r0.y, r5.w, c12.x
mul_pp r0.x, r0, r0.y
dp3_pp r1.w, r1, v2
mul_pp r4.xyz, r3, r0.w
mul_pp r0.xyz, r0.x, c4
mul_pp r0.xyz, r0, r4
mul_pp r5.xyz, r0, c13.z
dp3_pp r0.xw, r1, v3
dp3_pp r4.xw, r1, v4
mov_pp r1.x, r0
mul_pp r2.xyz, r2, c6.w
mov_pp r1.y, r4.x
mul_pp r4.xyz, r2, r5.w
mul_pp r4.xyz, r4, c4
mov r0.x, v2.w
mov r0.z, v4.w
mov r0.y, v3.w
...
mad r5.xyz, -r1, c11.x, r0
mul r1.xyz, r5.z, c2
mad r1.xyz, r5.y, c1, r1
mul r0.xyz, r4.w, c2
mad r0.xyz, r0.w, c1, r0
mad r0.xyz, r1.w, c0, r0
mad r1.xyz, r5.x, c0, r1
texld r0, r0, s4
...
dcl_2d s5
def c10, 2.00000000, -1.00000000, 7.00000000, 1.00000000
def c11, 0.95019531, 0.04998779, 8.00000000, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2
dcl_texcoord3 v3
...
add r0.z, -r1.w, c10.w
mad r4.xyz, r0.x, c0, r1
mul_pp r0.y, r0.z, r0.z
mul_pp r1.y, r0.z, r0
mul r3.xyz, r0.w, c2
mov_pp r0.x, c9
add_pp r0.x, c10.w, -r0
mov_pp r0.y, c9.x
mov_pp r1.x, r0.z
mul_pp r1.xy, r1, r0
mov_pp r1.w, r0.z
...
add_pp r0.y, r0.x, r0
texld r1, v0, s2
add_pp r0.x, -r1.w, c10.w
mad_pp r0.y, r0, c11.x, c11
mad_pp r0.x, -r0, r0, c10.w
mad_pp r0.x, -r0, c8, r0
add_pp r4.w, r0.x, c10.z
mul_pp r0.y, r0, c7.x
rsq_pp r0.y, r0.y
rcp_pp r0.x, r0.y
texldl r4, r4, s3
...
mul_pp r0.xyz, r0, c5.w
mul_pp r0.xyz, r1, r0
mul_pp r2.xyz, r4, r4.w
mul_pp r1.xyz, r2, r0
mad r3.xyz, r3.w, c1, r3
mad r0.xyz, r2.w, c0, r3
texld r0, r0, s4
texld r2, v0, s0
mul_pp r2, r2, c6
mul_pp r0.xyz, r0, r0.w
...
mul_pp r5.xyz, r5, c4
mad_pp r4.xyz, r5, c11.x, r4
mul r5.xyz, r5.w, c2
mad r5.xyz, r1.w, c1, r5
mad r5.xyz, r2.x, c0, r5
mov r1.x, v2.w
mov r1.z, v4.w
mov r1.y, v3.w
dp3 r4.w, r2, r1
mul r2.yzw, r2.xxyz, r4.w
mad r1.xyz, -r2.yzww, c11.x, r1
mul r2.yzw, r1.z, c2.xxyz
mad r1.yzw, r1.y, c1.xxyz, r2
mad r2.xyz, r1.x, c0, r1.yzww
texld r1, r5, s4
...
mul_pp r1.xyz, r3, r1
mad_pp r1.xyz, r1, c6.y, r2
mad_pp r0.xyz, r0, v6, r4
...
dcl_2d s6
def c10, 8.00000000, 2.00000000, -1.00000000, 7.00000000
def c11, 1.00000000, 0.95019531, 0.04998779, 0
dcl_texcoord0 v0.xy
dcl_texcoord1 v1.xyz
dcl_texcoord2 v2
dcl_texcoord3 v3
...
mul r3.xyz, r3.x, v1
dp3_sat r0.y, r2, r3
mad r3.xyz, -r4, c10.y, r1
add r0.y, -r0, c11.x
mul r1.xyz, r3.z, c2
mad r2.xyz, r3.y, c1, r1
mad r3.xyz, r3.x, c0, r2
mul_pp r0.z, r0.y, r0.y
mul_pp r1.y, r0, r0.z
mov_pp r0.z, c9.x
add_pp r4.x, c11, -r0.z
mov_pp r4.y, c9.x
mov_pp r1.x, r0.y
mul_pp r1.xy, r1, r4
mov_pp r2.y, r0
mov_pp r2.x, c11
mul_pp r4.zw, r4.xyxy, r2.xyxy
add_pp r1.y, r1.x, r1
texld r2, v0, s2
add_pp r1.x, r4.z, r4.w
mul_pp r1.xy, r1, r4
...
mad_pp r0.y, -r0, r0, c11.x
mad_pp r0.y, -r0, c8.x, r0
add_pp r3.w, r0.y, c10
mad_pp r0.z, r0, c11.y, c11
mul_pp r0.y, r0.z, c7.x
texldl r3, r3, s3
rsq_pp r0.y, r0.y
rcp_pp r0.y, r0.y
...
void main ()
{
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  vec3 tmpvar_10;
  tmpvar_10 = normalize (normalize (xlv_TEXCOORD2));
  float tmpvar_11;
  tmpvar_11 = clamp (dot (tmpvar_2, tmpvar_10), 0.0, 1.0);
  frag.xyz = ((((atten * 2.0) * tmpvar_11) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  frag.xyz = (frag.xyz + (((((vec3(pow (clamp (dot (tmpvar_2, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_10))), 0.0, 1.0), tmpvar_9)) * clamp ((10.0 * tmpvar_11), 0.0, 1.0)) * _LightColor0.xyz) * atten) * 0.5) * (spec.xyz * ((tmpvar_9 * 0.159155) + 0.31831))));
  c = frag;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  tmpvar_14 = vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3));
  lowp vec4 tmpvar_15;
  tmpvar_15 = texture2D (_LightTexture0, tmpvar_14);
  ...
  frag.xyz = ((((atten * 2.0) * tmpvar_16) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_17;
  tmpvar_17 = clamp (dot (tmpvar_1, normalize ((viewDir + lightDir_i0))), 0.0, 1.0);
  specRefl = tmpvar_17;
  highp vec3 tmpvar_18;
  tmpvar_18 = vec3(pow (specRefl, tmpvar_10));
...
void main ()
{
  ...
  frag.w = diff.w;
  frag.xyz = (frag.xyz + ((((vec3(pow (clamp (dot (tmpvar_2, normalize ((normalize (xlv_TEXCOORD1) + tmpvar_10))), 0.0, 1.0), tmpvar_9)) * clamp ((10.0 * tmpvar_11), 0.0, 1.0)) * _LightColor0.xyz) * 0.5) * (spec.xyz * ((tmpvar_9 * 0.159155) + 0.31831))));
  c = frag;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  frag.xyz = (((2.0 * tmpvar_13) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_14;
  tmpvar_14 = clamp (dot (tmpvar_1, normalize ((viewDir + lightDir_i0))), 0.0, 1.0);
  specRefl = tmpvar_14;
  highp vec3 tmpvar_15;
  tmpvar_15 = vec3(pow (specRefl, tmpvar_10));
  spec_i0_i1 = tmpvar_15;
  mediump vec3 tmpvar_16;
  tmpvar_16 = (((spec_i0_i1 * clamp ((10.0 * tmpvar_13), 0.0, 1.0)) * _LightColor0.xyz) * 0.5);
...
void main ()
{
  ...
  viewDir = tmpvar_13;
  mediump float atten;
  atten = ((float((xlv_TEXCOORD3.z > 0.0)) * tmpvar_14.w) * tmpvar_16.w);
  mediump vec3 spec_i0_i1;
  highp float specRefl;
  mediump vec4 frag;
  frag = vec4(0.0, 0.0, 0.0, 1.0);
...
void main ()
{
  ...
  frag = vec4(0.0, 0.0, 0.0, 1.0);
  mediump float tmpvar_14;
  tmpvar_14 = clamp (dot (tmpvar_1, lightDir_i0), 0.0, 1.0);
  frag.xyz = ((((atten * 2.0) * tmpvar_14) * diff.xyz) * _LightColor0.xyz);
  frag.w = diff.w;
  mediump float tmpvar_15;
  tmpvar_15 = clamp (dot (tmpvar_1, normalize ((viewDir + lightDir_i0))), 0.0, 1.0);
  specRefl = tmpvar_15;
  highp vec3 tmpvar_16;
  tmpvar_16 = vec3(pow (specRefl, tmpvar_10));
  spec_i0_i1 = tmpvar_16;
  mediump vec3 tmpvar_17;
  tmpvar_17 = ((((spec_i0_i1 * clamp ((10.0 * tmpvar_14), 0.0, 1.0)) * _LightColor0.xyz) * atten) * 0.5);
  spec_i0_i1 = tmpvar_17;
  frag.xyz = (frag.xyz + (tmpvar_17 * tmpvar_2));
  c = frag;
  c.w = 0.0;
  gl_FragData[0] = c;
}
